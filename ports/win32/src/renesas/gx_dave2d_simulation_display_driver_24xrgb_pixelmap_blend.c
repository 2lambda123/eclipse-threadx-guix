...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_24xrgb_pixelmap_compressed_alpha_blend(
...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_24xrgb_pixelmap_compressed_blend(
    GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap,
    GX_UBYTE alpha) {
  INT xval;
  INT yval;
...
VOID _gx_dave2d_simulation_display_driver_24xrgb_pixelmap_blend(
  ...
  if (pixelmap->gx_pixelmap_flags & GX_PIXELMAP_COMPRESSED) {
    if (pixelmap->gx_pixelmap_flags & GX_PIXELMAP_ALPHA) {
      _gx_dave2d_simulation_display_driver_24xrgb_pixelmap_compressed_alpha_blend(
          context, xpos, ypos, pixelmap, alpha);
    } else {
      _gx_dave2d_simulation_display_driver_24xrgb_pixelmap_compressed_blend(
          context, xpos, ypos, pixelmap, alpha);
    }
  ...
  if (!synergy_specific_format && !drawn) {
    _gx_display_driver_24xrgb_pixelmap_blend(context, xpos, ypos, pixelmap,
                                             alpha);
  }
}
