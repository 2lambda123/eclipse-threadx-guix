...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_565rgb_rotated_horizontal_pixelmap_line_compressed_write(
    GX_DRAW_CONTEXT *context, INT ystart, INT yend, INT x,
  ...
  if (context->gx_draw_context_display->gx_display_rotation_angle ==
    ...
    y = x;
    info->x_offset = (yend - ystart + 1 + info->x_offset) %
                     info->pixelmap->gx_pixelmap_height;
...
VOID _gx_dave2d_simulation_display_driver_565rgb_rotated_horizontal_pixelmap_line_draw(
  ...
  if (drawn) {
    ...
    if (info->current_pixel_ptr >= info->pixelmap->gx_pixelmap_data +
                                       info->pixelmap->gx_pixelmap_data_size) {
