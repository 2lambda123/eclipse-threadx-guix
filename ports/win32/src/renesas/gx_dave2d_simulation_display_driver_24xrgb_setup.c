...
VOID _gx_dave2d_simulation_display_driver_24xrgb_setup(
  ...
  display->gx_display_driver_pixelmap_draw =
      _gx_dave2d_simulation_display_driver_24xrgb_pixelmap_draw;
  ...
  display->gx_display_driver_4bit_compressed_glyph_draw =
      _gx_dave2d_simulation_display_driver_compressed_glyph_4bit_draw;
  ...
  display->gx_display_driver_horizontal_pixelmap_line_draw =
      _gx_dave2d_simulation_display_driver_32bpp_horizontal_pixelmap_line_draw;
}
