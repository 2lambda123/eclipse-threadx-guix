...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_565rgb_pixelmap_compressed_write(
...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_16bpp_4444argb_pixelmap_compressed_alpha_write(
    GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap) {
  INT yval;
  INT xval;
  GX_CONST UCHAR *get;
...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_16bpp_4444bgra_pixelmap_compressed_alpha_write(
    GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap) {
  INT yval;
  INT xval;
  GX_CONST UCHAR *get;
...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_16bpp_32argb_pixelmap_raw_write(
    GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap) {
  INT skipcount;
  INT xval;
  INT yval;
  ...
  GX_RECTANGLE *clip;
  VOID (*blend_function)
  (GX_DRAW_CONTEXT *context, INT xcoord, INT ycoord, GX_COLOR fcolor,
   GX_UBYTE alpha);
  VOID (*write_function)
  (GX_DRAW_CONTEXT *context, INT xcoord, INT ycoord, GX_COLOR color);
  GX_UBYTE alpha;
  GX_UBYTE brush_alpha;
  int temp_alpha;
  USHORT color;
  ...
  for (yval = clip->gx_rectangle_top; yval <= clip->gx_rectangle_bottom;
       yval++) {
    get = getrow;

    for (xval = clip->gx_rectangle_left; xval <= clip->gx_rectangle_right;
         xval++) {
...
VOID _gx_dave2d_simulation_display_driver_565rgb_pixelmap_blend(
  ...
  if (!synergy_specific_format && !drawn) {
    if (alpha == 0xff) {
      ...
      _gx_display_driver_565rgb_pixelmap_blend(context, xpos, ypos, pixelmap,
                                               alpha);
    }
  }
}
