...
/**************************************************************************/
static VOID
_gx_dave2d_simulation_display_driver_565rgb_horizontal_pixelmap_line_compressed_write(
...
VOID _gx_dave2d_simulation_display_driver_565rgb_horizontal_pixelmap_line_draw(
  ...
  if (!synergy_specific_format && !drawn) {
    _gx_display_driver_565rgb_horizontal_pixelmap_line_draw(context, xstart,
                                                            xend, y, info);
    return;
  }
