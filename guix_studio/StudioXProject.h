...
public:
    ...
    int GetPixelmapFrameCount() {
        return map_list.GetCount();
    }
...
public:
    ...
    widget_info *GetChildWidgetInfo() const {
        return child;
    };
    void SetChildWidgetInfo(widget_info *info);
    widget_info *GetNextWidgetInfo() const {
        return next;
    };
...
public:
    ...
    widget_info *GetFirstChildWidget() const {
        return first_widget;
    };
    void SetFirstChildWidget(widget_info *info);

    folder_info *GetNextFolder() const {
        return next;
    };
...
public:
    ...
    res_info *GetFirstResourceInfo() const {
...
public:
    ...
    folder_info *GetFirstChildFolder() const {
        return first_folder;
    };
...
public:
    ...
    BOOL IsWidgetPositionLocked() {
        return mHeader.is_widget_position_locked;
    }
