...
/* Define the major/minor version information that can be used by the
   application and the GUIX source as well.  */
...
/* Define data types used by GUIX that are normally defined within ThreadX
 * headers  */
...
/* Define configuration-specific constants. These constants can be redefined
 * externally.  */
...
#define GX_SYSTEM_TIMER_TICKS                                                  \
  ((GX_SYSTEM_TIMER_MS * TX_TIMER_TICKS_PER_SECOND) / 1000)
#endif
...
#define GX_COLOR_FORMAT_MONOCHROME                                             \
  1 /* 0 = black, 1 = white                     */
#define GX_COLOR_FORMAT_MONOCHROME_INVERTED                                    \
  2 /* 1 = black, 0 = white                     */
#define GX_COLOR_FORMAT_2BIT_GRAY                                              \
  3 /* 2 bit-per-pixel grayscale                */
#define GX_COLOR_FORMAT_2BIT_GRAY_INVERTED                                     \
  4 /* 2 bit-per-pixel grayscale inverted       */
#define GX_COLOR_FORMAT_4BIT_GRAY                                              \
  5 /* 4 bit-per-pixel grayscale                */
#define GX_COLOR_FORMAT_4BIT_GRAY_INVERTED 6
#define GX_COLOR_FORMAT_4BIT_VGA                                               \
  7 /* Obsolete VGA planar format, 16 colors    */
#define GX_COLOR_FORMAT_8BIT_GRAY                                              \
  8 /* 256 shades of gray                       */
#define GX_COLOR_FORMAT_8BIT_GRAY_INVERTED                                     \
  9 /* 256 shades of gray, 0 = white            */
#define GX_COLOR_FORMAT_8BIT_PALETTE                                           \
  10 /* 256 color palette mode                   */
#define GX_COLOR_FORMAT_8BIT_PACKED_PIXEL                                      \
  11 /* 3:3:2 color mode                         */
#define GX_COLOR_FORMAT_5551BGRX                                               \
  12 /* 15 bpp, b:g:r order                      */
#define GX_COLOR_FORMAT_1555XRGB                                               \
  13                              /* 15 bpp, r:g:b order                      */
#define GX_COLOR_FORMAT_565RGB 14 /* 16 bpp, r:g:b order */
#define GX_COLOR_FORMAT_4444ARGB                                               \
  15 /* 16 bpp, 4:4:4:4 argb order               */
#define GX_COLOR_FORMAT_4444BGRA                                               \
  16                              /* 16 bpp, 4:4:4:4 bgra order               */
...
#define GX_COLOR_FORMAT_8BIT_ALPHAMAP                                          \
  26 /* 8 bit alpha only                         */
...
/* Predefined a:r:g:b color values, these follow the standard 16 VGA color
 * names.  */
...
#define GX_SPRITE_BACKGROUND_NO_ACTION                                         \
  0x00 /* do nothing between frames            */
#define GX_SPRITE_BACKGROUND_SOLID_FILL                                        \
  0x01 /* draw background with solid color     */
#define GX_SPRITE_BACKGROUND_RESTORE                                           \
  0x02 /* draw background with first image     */
...
#define GX_BRUSH_SOLID_FILL                                                    \
  0x0001U /* For rectangle, text, polygon              */
#define GX_BRUSH_PIXELMAP_FILL                                                 \
  0x0002U                      /* For rectangle, polygon                    */
#define GX_BRUSH_ALIAS 0x0004U /* For lines                                 */
#define GX_BRUSH_UNDERLINE                                                     \
  0x0008U                      /* Underlined text                           */
...
#define GX_CANVAS_COMPOSITE 0x20 /* Canvas is a buffer for creating            \
                                    composite*/
...
#define GX_PROMPT_BIDI_RESOLVED_TEXT_INFO                                      \
  GX_BIDI_RESOLVED_TEXT_INFO *gx_prompt_bidi_resolved_text_info;
...
#define GX_TEXT_SCROLL_WHEEL_TEXT_GET_DEPRECATED                               \
  GX_CONST GX_CHAR *(*gx_text_scroll_wheel_text_get_deprecated)(               \
      struct GX_TEXT_SCROLL_WHEEL_STRUCT *, INT);
#else
#define GX_STRING_SCROLL_WHEEL_STRING_LIST_DEPRECATED
#define GX_TEXT_SCROLL_WHEEL_TEXT_GET_DEPRECATED
#endif
...
typedef struct GX_FONT_STRUCT {
  ...
  union {
    ...
    GX_CONST GX_COMPRESSED_GLYPH *
        gx_font_compressed_glyphs; /* Array of GX_COMPRESSED_GLYPH structures */
#if defined(GX_FONT_KERNING_SUPPORT)
    GX_CONST GX_KERNING_GLYPH
        *gx_font_kerning_glyphs; /* Array of GX_KERNING_GLYPH structures     */
#endif
  } gx_font_glyphs;
  GX_CONST struct GX_FONT_STRUCT
      *gx_font_next_page; /* For multiple page fonts (Unicode)        */
} GX_FONT;
...
#define GX_FONT_FORMAT_REVERSED_ORDER                                          \
  0x80 /* For 4bpp font, half bytes order reversed. For 1bpp font, bits order  \
          reversed with least signigicant bit in left. */
...
#define GX_PIXELMAP_TRANSPARENT                                                \
  0x01 /* Pixelmap has transparent pixels          */
#define GX_PIXELMAP_COMPRESSED                                                 \
  0x02                         /* Pixelmap is compressed format            */
...
#define GX_PIXELMAP_RAW_FORMAT                                                 \
  0x10 /* RAW JPG/PNG format                       */
#define GX_PIXELMAP_DYNAMICALLY_ALLOCATED                                      \
  0x20 /* Pixelmap is dynamically allocated        */
...
#define PIXELMAP_IS_TRANSPARENT(a)                                             \
  (a->gx_pixelmap_flags & (GX_PIXELMAP_TRANSPARENT | GX_PIXELMAP_ALPHA))
...
/* Define Event type.  Note: the size of this structure must be less than or
   equal to the constant GX_EVENT_SIZE defined previously.  */
...
/* Define Scroll information structure. This structure is used to define the
   position and scaling of the scroll bar thumb button.  */
...
/* Define Progress bar information structure. This structure is used to define
...
typedef struct GX_RADIAL_PROGRESS_BAR_INFO_STRUCT {
  ...
  GX_VALUE gx_radial_progress_bar_info_anchor_val;  /* starting angle for the
                                                       circular arc.  */
  GX_RESOURCE_ID gx_radial_progress_bar_info_font_id;
  GX_RESOURCE_ID
      gx_radial_progress_bar_info_normal_text_color; /* resource ID of color for
                                                        normal text.  */
  GX_RESOURCE_ID
      gx_radial_progress_bar_info_selected_text_color; /* resource ID of color
                                                          for selected text.  */
  GX_RESOURCE_ID gx_radial_progress_bar_info_disabled_text_color;
  GX_VALUE gx_radial_progress_bar_info_normal_brush_width;   /* width of lower
                                                                track.  */
  GX_VALUE gx_radial_progress_bar_info_selected_brush_width; /* width of upper
                                                                track.  */
  GX_RESOURCE_ID
      gx_radial_progress_bar_info_normal_brush_color; /* resource ID of color
                                                         for lower track.  */
  GX_RESOURCE_ID
      gx_radial_progress_bar_info_selected_brush_color; /* resource ID of color
                                                           for upper track.  */
...
/* Display layer services structure type. These services may be provided by
   display drivers support multiple hardware graphics layers. */

typedef struct GX_DISPLAY_LAYER_SERVICES_STRUCT {
  UINT (*gx_display_layer_initialize)
  (INT layer, struct GX_CANVAS_STRUCT *canvas);
  ...
  VOID (*gx_display_layer_offset_set)
  (INT layer, GX_VALUE xoffset, GX_VALUE yoffset);
  VOID (*gx_display_layer_active_display_area_set)
  (INT layer, GX_RECTANGLE *size);
} GX_DISPLAY_LAYER_SERVICES;
...
typedef struct GX_DISPLAY_STRUCT {
  ...
  struct GX_DISPLAY_STRUCT
      *gx_display_created_next; /* Pointer to next control block            */
  struct GX_DISPLAY_STRUCT
      *gx_display_created_previous; /* Pointer to previous control block */

  GX_COLOR *gx_display_color_table; /* color ID to native value mapping table */
  GX_PIXELMAP *
      *gx_display_pixelmap_table; /* pixelmap ID to GX_PIXELMAP mapping table */
...
#endif
  GX_CONST GX_STRING *
      *gx_display_language_table; /* Define the language table.               */
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
  GX_CONST GX_UBYTE *gx_display_language_direction_table; /* Define the langauge
                                                             direction table. */
#endif
  ...
  GX_DISPLAY_LAYER_SERVICES
      *gx_display_layer_services; /* optional additional hardware graphics layer
                                     services */

  /* function to initiate drawing sequence */
  VOID (*gx_display_driver_drawing_initiate)
  (struct GX_DISPLAY_STRUCT *display, struct GX_CANVAS_STRUCT *canvas);

  /* function to terminate drawing sequence */
  VOID (*gx_display_driver_drawing_complete)
  (struct GX_DISPLAY_STRUCT *display, struct GX_CANVAS_STRUCT *canvas);

  /* function for installing palette (only used for certain palette mode
   * drivers) */
  VOID (*gx_display_driver_palette_set)
  (struct GX_DISPLAY_STRUCT *display, GX_COLOR *palette, INT count);

  /* Function for drawing non-aliased, single pixel line */
  VOID (*gx_display_driver_simple_line_draw)
  (GX_DRAW_CONTEXT *context, INT x1, INT y1, INT x2, INT y2);
  ...
  (GX_DRAW_CONTEXT *context, INT x1, INT x2, INT ypos, INT width,
   GX_COLOR color);
  VOID (*gx_display_driver_horizontal_pixelmap_line_draw)
  (GX_DRAW_CONTEXT *context, INT xstart, INT xend, INT y,
   GX_FILL_PIXELMAP_INFO *info);
  VOID (*gx_display_driver_vertical_line_draw)
  (GX_DRAW_CONTEXT *context, INT y1, INT y2, INT xpos, INT width,
   GX_COLOR color);
  VOID (*gx_display_driver_horizontal_pattern_line_draw)
  (GX_DRAW_CONTEXT *context, INT x1, INT x2, INT ypos);
  VOID (*gx_display_driver_vertical_pattern_line_draw)
  (GX_DRAW_CONTEXT *context, INT y1, INT y2, INT xpos);
  /* Define driver function pointers for canvas composite */
  VOID (*gx_display_driver_canvas_copy)
  (struct GX_CANVAS_STRUCT *source, struct GX_CANVAS_STRUCT *dest);
  /* Define driver function pointers for canvas composite */
  ...
  (GX_DRAW_CONTEXT *context, INT x, INT y, GX_PIXELMAP *pixelmap);
  VOID (*gx_display_driver_png_draw)
  (GX_DRAW_CONTEXT *context, INT x, INT y, GX_PIXELMAP *pixelmap);
#endif

  VOID (*gx_display_driver_pixelmap_rotate)
  (GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap,
   INT angle, INT rot_cx, INT rot_cy);

  /* Define driver function pointer for low-level pixel writing.  */
  VOID (*gx_display_driver_pixel_write)
  (GX_DRAW_CONTEXT *context, INT x, INT y, GX_COLOR color);

  /* Define driver function for block move. */
  VOID (*gx_display_driver_block_move)
  (GX_DRAW_CONTEXT *context, GX_RECTANGLE *block, INT xshift, INT yshift);

  /* Define driver function pointer for low-level pixel blending.  */
  VOID (*gx_display_driver_pixel_blend)
  (GX_DRAW_CONTEXT *context, INT x, INT y, GX_COLOR color, GX_UBYTE alpha);

  /* Define driver function pointer to convert 32-bit color to native format. */
  GX_COLOR (*gx_display_driver_native_color_get)
  (struct GX_DISPLAY_STRUCT *display, GX_COLOR rawcolor);

  /* Define driver function pointer to return row pitch, in bytes, for given
   * canvas width.  */
  USHORT (*gx_display_driver_row_pitch_get)(USHORT width);

  /* Define driver function pointer for low-level buffer toggle.  */
  VOID (*gx_display_driver_buffer_toggle)
  (struct GX_CANVAS_STRUCT *canvas, GX_RECTANGLE *dirty_area);

  /* Define driver function pointer for drawing polygon.  */
  VOID (*gx_display_driver_polygon_draw)
  (GX_DRAW_CONTEXT *context, GX_POINT *vertex, INT num);

  /* Define driver function pointer for filling polygon shape.  */
  VOID (*gx_display_driver_polygon_fill)
  (GX_DRAW_CONTEXT *context, GX_POINT *vertex, INT num);

  /* Define driver function pointer for drawing aliased 8bit glyph (may be
   * NULL).  */
  VOID (*gx_display_driver_8bit_glyph_draw)
  (GX_DRAW_CONTEXT *context, GX_RECTANGLE *draw_area, GX_POINT *map_offset,
   GX_CONST GX_GLYPH *glyph);

  /* Define driver function pointer for drawing aliased 4bit glyph (may be
   * NULL).  */
  ...
  /* Define driver function pointer for drawing aliased 8bit compressed glyph
   * (may be NULL).  */
  VOID (*gx_display_driver_8bit_compressed_glyph_draw)
  (GX_DRAW_CONTEXT *context, GX_RECTANGLE *draw_area, GX_POINT *map_offset,
   GX_CONST GX_GLYPH *glyph);

  /* Define driver function pointer for drawing aliased 4bit compressed glyph
   * (may be NULL).  */
  VOID (*gx_display_driver_4bit_compressed_glyph_draw)
  (GX_DRAW_CONTEXT *context, GX_RECTANGLE *draw_area, GX_POINT *map_offset,
   GX_CONST GX_GLYPH *glyph);

  /* Define driver function pointer for drawing 1bit (monochrome) compressed
   * glyph.  */
  ...
  (GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, UINT r);
  ...
  /* Define driver function pointer for drawing anti-aliased circle with wide
   * outlines.  */
  ...
  (GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, UINT r, INT start_angle,
   INT end_angle);
  ...
  /* Define driver function pointer for drawing anti-aliased circle arc with
   * wide outlines. */
  ...
  VOID (*gx_display_driver_wide_ellipse_draw)
  (GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, INT a, INT b);

  /* Define driver function pointer for drawing anti-aliased ellipse with wide
   * outlines.  */
  ...
  VOID (*gx_display_mouse_position_set)
  (struct GX_DISPLAY_STRUCT *display, GX_POINT *pos);
  VOID (*gx_display_mouse_enable)
  (struct GX_DISPLAY_STRUCT *display, GX_BOOL enable);
#if !defined(GX_HARDWARE_MOUSE_SUPPORT)
...
typedef struct GX_RICH_TEXT_CONTEXT_STACK_STRUCT {
  GX_RICH_TEXT_CONTEXT
      gx_rich_text_context_stack[GX_MAX_RICH_TEXT_CONTEXT_NESTING];
...
#define GX_RADIAL_PROGRESS_BAR_CANVAS_FIELD                                    \
  GX_CANVAS gx_radial_progress_bar_canvas;
#else
...
#define GX_WIDGET_MEMBERS_DECLARE                                              \
  ...
  UINT (*gx_widget_event_process_function)                                     \
  (struct GX_WIDGET_STRUCT *, GX_EVENT *);                                     \
...
#define GX_NUMERIC_PROMPT_MEMBERS_DECLARE                                      \
  ...
  VOID (*gx_numeric_prompt_format_function)                                    \
  (struct GX_NUMERIC_PROMPT_STRUCT *, INT);
...
#define GX_NUMERIC_PIXELMAP_PROMPT_MEMBERS_DECLARE                             \
  ...
  VOID (*gx_numeric_pixelmap_prompt_format_function)                           \
  (struct GX_NUMERIC_PIXELMAP_PROMPT_STRUCT *, INT);
...
#define GX_MULTI_LINE_TEXT_BUTTON_MEMBERS_DECLARE                              \
  ...
  GX_STRING                                                                    \
      gx_multi_line_text_button_lines[GX_MULTI_LINE_TEXT_BUTTON_MAX_LINES];
...
#define GX_WINDOW_MEMBERS_DECLARE                                              \
  ...
  VOID (*gx_window_scroll_info_get)                                            \
  (struct GX_WINDOW_STRUCT * window, ULONG style, GX_SCROLL_INFO * info);      \
...
#define GX_VERTICAL_LIST_MEMBERS_DECLARE                                       \
  GX_WINDOW_MEMBERS_DECLARE                                                    \
  VOID (*gx_vertical_list_callback)                                            \
  (struct GX_VERTICAL_LIST_STRUCT *, GX_WIDGET * widget, INT index);           \
...
#define GX_HORIZONTAL_LIST_MEMBERS_DECLARE                                     \
  GX_WINDOW_MEMBERS_DECLARE                                                    \
  VOID (*gx_horizontal_list_callback)                                          \
  (struct GX_HORIZONTAL_LIST_STRUCT *, GX_WIDGET * widget, INT index);         \
...
#define GX_RADIAL_SLIDER_MEMBERS_DECLARE                                       \
  ...
  VOID (*gx_radial_slider_animation_update_callback)                           \
  (struct GX_RADIAL_SLIDER_STRUCT * slider);
...
#define GX_SCROLL_WHEEL_MEMBERS_DECLARE                                        \
  GX_WINDOW_MEMBERS_DECLARE                                                    \
  UINT (*gx_scroll_wheel_scroll)                                               \
  (struct GX_SCROLL_WHEEL_STRUCT * wheel, GX_VALUE amount);                    \
  GX_BOOL (*gx_scroll_wheel_wrap_style_check)                                  \
  (struct GX_SCROLL_WHEEL_STRUCT * wheel);                                     \
...
#define GX_GENERIC_SCROLL_WHEEL_MEMBERS_DECLARE                                \
  ...
  VOID (*gx_generic_scroll_wheel_callback)                                     \
  (struct GX_GENERIC_SCROLL_WHEEL_STRUCT *, GX_WIDGET * widget, INT index);    \
...
#define GX_TEXT_SCROLL_WHEEL_MEMBERS_DECLARE                                   \
  ...
  UINT (*gx_text_scroll_wheel_text_get)                                        \
  (struct GX_TEXT_SCROLL_WHEEL_STRUCT *, INT, GX_STRING *);                    \
...
#define GX_NUMERIC_SCROLL_WHEEL_MEMBERS_DECLARE                                \
  ...
  GX_CHAR gx_numeric_scroll_wheel_string_buffer                                \
...
typedef struct GX_ANIMATION_STRUCT {
  ...
  UINT (*gx_animation_original_event_process_function)
  (struct GX_WIDGET_STRUCT *, GX_EVENT *);
...
typedef struct GX_IMAGE_READER_STRUCT {
  UINT (*gx_image_reader_pixel_write)
  (struct GX_IMAGE_READER_STRUCT *image_reader, GX_PIXEL *pixel);
  UINT (*gx_image_reader_pixel_read)
  (struct GX_IMAGE_READER_STRUCT *image_reader, INT index, GX_PIXEL *pixel);
...
#define GX_FIXED_VAL_RND(_a)                                                   \
  (GX_VALUE)((((GX_FIXED_VAL)_a) + GX_FIXED_VAL_HALF) >> GX_FIXED_VAL_SHIFT)
#define GX_FIXED_VAL_RND_UP(_a)                                                \
  ((((GX_FIXED_VAL)_a) + GX_FIXED_VAL_ONE - 1) >> GX_FIXED_VAL_SHIFT)
...
#define gx_accordion_menu_create(a, b, c, d, e, f)                             \
  _gx_accordion_menu_create(a, b, c, d, e, f)
...
#define gx_button_create(a, b, c, d, e, f)                                     \
  _gx_button_create(a, b, (GX_WIDGET *)c, d, e, f)
...
#define gx_canvas_drawing_initiate(a, b, c)                                    \
  _gx_canvas_drawing_initiate(a, (GX_WIDGET *)b, c)
...
#define gx_checkbox_create(a, b, c, d, e, f, g)                                \
  _gx_checkbox_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
#define gx_display_language_direction_table_set                                \
  _gx_display_language_direction_table_set
#endif
...
#define gx_drop_list_create(a, b, c, d, e, f, g, h, i)                         \
  _gx_drop_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, i)
...
#define gx_generic_scroll_wheel_children_position                              \
...
#define gx_generic_scroll_wheel_event_process                                  \
  _gx_generic_scroll_wheel_event_process
#define gx_generic_scroll_wheel_row_height_set                                 \
  _gx_generic_scroll_wheel_row_height_set
#define gx_generic_scroll_wheel_total_rows_set                                 \
...
#define gx_horizontal_list_page_index_set(a, b)                                \
  _gx_horizontal_list_page_index_set((GX_HORIZONTAL_LIST *)a, b)
#define gx_horizontal_list_selected_index_get(a, b)                            \
  _gx_horizontal_list_selected_index_get(a, b)
#define gx_horizontal_list_selected_set(a, b)                                  \
  _gx_horizontal_list_selected_set(a, b)
#define gx_horizontal_list_selected_widget_get(a, b)                           \
  _gx_horizontal_list_selected_widget_get(a, (GX_WIDGET **)b)
#define gx_horizontal_list_total_columns_set(a, b)                             \
  _gx_horizontal_list_total_columns_set((GX_HORIZONTAL_LIST *)a, b)

#define gx_horizontal_scrollbar_create(a, b, c, d, e)                          \
  _gx_horizontal_scrollbar_create(a, b, (GX_WINDOW *)c, d, e)

#define gx_icon_background_draw _gx_icon_background_draw
#define gx_icon_button_create(a, b, c, d, e, f, g)                             \
  _gx_icon_button_create(a, b, (GX_WIDGET *)c, d, e, f, g)
#define gx_icon_button_draw _gx_icon_button_draw
#define gx_icon_button_pixelmap_set _gx_icon_button_pixelmap_set
#define gx_icon_create(a, b, c, d, e, f, g, h)                                 \
  _gx_icon_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_line_chart_create(a, b, c, d, e, f, g)                              \
  _gx_line_chart_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#define gx_menu_create(a, b, c, d, e, f, g, h)                                 \
  _gx_menu_create((GX_MENU *)a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_multi_line_text_input_char_insert                                   \
  _gx_multi_line_text_input_char_insert
#endif
#define gx_multi_line_text_input_char_insert_ext                               \
...
#define gx_multi_line_text_input_cursor_pos_get                                \
...
#define gx_multi_line_text_input_event_process                                 \
  _gx_multi_line_text_input_event_process
#define gx_multi_line_text_input_fill_color_set                                \
...
#define gx_multi_line_text_view_event_process                                  \
  _gx_multi_line_text_view_event_process
#define gx_multi_line_text_view_font_set _gx_multi_line_text_view_font_set
#define gx_multi_line_text_view_line_space_set                                 \
  _gx_multi_line_text_view_line_space_set
#define gx_multi_line_text_view_scroll_info_get                                \
  _gx_multi_line_text_view_scroll_info_get
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_multi_line_text_view_text_color_set(a, b, c)                        \
  _gx_multi_line_text_view_text_color_set((GX_MUILTI_LINE_TEXT_VIEW *)a, b, c, \
                                          b)
#else
#define gx_multi_line_text_view_text_color_set                                 \
...
#endif
#define gx_multi_line_text_view_text_set_ext                                   \
...
#define gx_rich_text_view_create(a, b, c, d, e, f, g, h)                       \
  _gx_rich_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_numeric_pixelmap_prompt_format_function_set                         \
...
#define gx_numeric_prompt_format_function_set                                  \
...
#define gx_progress_bar_create(a, b, c, d, e, f, g)                            \
  _gx_progress_bar_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#define gx_progress_bar_info_set(a, b)                                         \
  _gx_progress_bar_info_set((GX_PROGRESS_BAR *)a, b)
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_progress_bar_text_color_set(a, b, c)                                \
  _gx_progress_bar_text_color_set((GX_PROGRESS_BAR *)a, b, c, b)
#else
...
#define gx_prompt_create(a, b, c, d, e, f, g)                                  \
  _gx_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_prompt_text_color_set(a, b, c)                                      \
  _gx_prompt_text_color_set((GX_PROGRESS_BAR *)a, b, c, b)
#else
...
#define gx_radial_progress_bar_background_draw                                 \
...
#define gx_radial_progress_bar_event_process                                   \
...
#else
#define gx_radial_progress_bar_text_color_set                                  \
...
#define gx_radio_button_create(a, b, c, d, e, f, g)                            \
  _gx_radio_button_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#define gx_scroll_wheel_gradient_alpha_set(a, b, c)                            \
  _gx_scroll_wheel_gradient_alpha_set((GX_SCROLL_WHEEL *)a, b, c)
#define gx_scroll_wheel_row_height_set(a, b)                                   \
  _gx_scroll_wheel_row_height_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_background_set(a, b)                          \
  _gx_scroll_wheel_selected_background_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_get(a, b)                                     \
  _gx_scroll_wheel_selected_get((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_set(a, b)                                     \
  _gx_scroll_wheel_selected_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_speed_set(a, b, c, d, e)                               \
  _gx_scroll_wheel_speed_set((GX_SCROLL_WHEEL *)a, b, c, d, e)
#define gx_scroll_wheel_total_rows_set(a, b)                                   \
  _gx_scroll_wheel_total_rows_set((GX_SCROLL_WHEEL *)a, b)

#define gx_single_line_text_input_backspace(a)                                 \
  _gx_single_line_text_input_backspace((GX_SINGLE_LINE_TEXT_INPUT *)a)
...
#define gx_single_line_text_input_character_delete(a)                          \
  _gx_single_line_text_input_character_delete(a)
#define gx_single_line_text_input_character_insert(a, b, c)                    \
  _gx_single_line_text_input_character_insert(a, b, c)
...
#define gx_single_line_text_input_draw_position_get(a, b, c)                   \
  _gx_single_line_text_input_draw_position_get(a, b, c)
#define gx_single_line_text_input_end(a)                                       \
  _gx_single_line_text_input_end((GX_SINGLE_LINE_TEXT_INPUT *)a)
...
#define gx_single_line_text_input_fill_color_set(a, b, c, d, e)                \
  _gx_single_line_text_input_fill_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, \
                                            c, d, e)
#define gx_single_line_text_input_home(a)                                      \
  _gx_single_line_text_input_home((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_left_arrow(a)                                \
  _gx_single_line_text_input_left_arrow((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_position_get(a, b)                           \
  _gx_single_line_text_input_position_get(a, b)
#define gx_single_line_text_input_right_arrow(a)                               \
  _gx_single_line_text_input_right_arrow((GX_SINGLE_LINE_TEXT_INPUT *)a)
...
#define gx_single_line_text_input_text_color_set(a, b, c, d, e)                \
  _gx_single_line_text_input_text_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, \
                                            c, d, e)
#define gx_single_line_text_input_text_select                                  \
  _gx_single_line_text_input_text_select
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_single_line_text_input_text_set _gx_single_line_text_input_text_set
#endif
#define gx_single_line_text_input_text_set_ext                                 \
  _gx_single_line_text_input_text_set_ext

#define gx_slider_create(a, b, c, d, e, f, g, h)                               \
  _gx_slider_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_sprite_create(a, b, c, d, e, f, g, h)                               \
  _gx_sprite_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_string_scroll_wheel_create(a, b, c, d, e, f, g, h)                  \
  _gx_string_scroll_wheel_create(a, b, c, d, e, f, g, h)
#define gx_string_scroll_wheel_string_list_set                                 \
...
#define gx_string_scroll_wheel_event_process                                   \
  _gx_string_scroll_wheel_event_process
#define gx_string_scroll_wheel_string_id_list_set                              \
  _gx_string_scroll_wheel_string_id_list_set
#define gx_string_scroll_wheel_string_list_set_ext                             \
...
#define gx_system_dirty_partial_add(a, b)                                      \
  _gx_system_dirty_partial_add((GX_WIDGET *)a, b)
...
#define gx_system_timer_start(a, b, c, d)                                      \
...
#define gx_text_button_create(a, b, c, d, e, f, g)                             \
  _gx_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_text_button_text_color_set(a, b, c)                                 \
  _gx_text_button_text_color_set((GX_TEXT_BUTTON *)a, b, c)
#else
...
#define gx_text_input_cursor_blink_interval_set                                \
...
#define gx_text_scroll_wheel_callback_set(a, b)                                \
  _gx_text_scroll_wheel_callback_set(                                          \
      (GX_TEXT_SCROLL_WHEEL *)a,                                               \
...
#define gx_text_scroll_wheel_font_set(a, b, c)                                 \
  _gx_text_scroll_wheel_font_set((GX_TEXT_SCROLL_WHEEL *)a, b, c)
#if defined(GUIX_5_4_0_COMPATIBILITY)
...
#define gx_tree_view_create(a, b, c, d, e, f)                                  \
  _gx_tree_view_create((GX_TREE_VIEW *)a, b, (GX_WIDGET *)c, d, e, f)
...
#define gx_utility_bidi_paragraph_reorder_ext                                  \
  _gx_utility_bidi_paragraph_reorder_ext
#define gx_utility_bidi_resolved_text_info_delete                              \
...
#define gx_vertical_list_create(a, b, c, d, e, f, g, h)                        \
  _gx_vertical_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
#define gx_vertical_list_event_process _gx_vertical_list_event_process
#define gx_vertical_list_page_index_set(a, b)                                  \
  _gx_vertical_list_page_index_set((GX_VERTICAL_LIST *)a, b)
#define gx_vertical_list_selected_index_get(a, b)                              \
  _gx_vertical_list_selected_index_get(a, b)
#define gx_vertical_list_selected_set(a, b) _gx_vertical_list_selected_set(a, b)
#define gx_vertical_list_selected_widget_get(a, b)                             \
  _gx_vertical_list_selected_widget_get(a, (GX_WIDGET **)b)
#define gx_vertical_list_total_rows_set(a, b)                                  \
  _gx_vertical_list_total_rows_set((GX_VERTICAL_LIST *)a, b)

#define gx_vertical_scrollbar_create(a, b, c, d, e)                            \
  _gx_vertical_scrollbar_create(a, b, (GX_WINDOW *)c, d, e)
...
#define gx_widget_back_attach(a, b)                                            \
  _gx_widget_back_attach((GX_WIDGET *)a, (GX_WIDGET *)b)
...
#define gx_widget_block_move(a, b, c, d)                                       \
  _gx_widget_block_move((GX_WIDGET *)a, b, c, d)
#define gx_widget_border_draw(a, b, c, d, e)                                   \
  _gx_widget_border_draw((GX_WIDGET *)a, b, c, d, e)
#define gx_widget_border_style_set(a, b)                                       \
  _gx_widget_border_style_set((GX_WIDGET *)a, b)
#define gx_widget_border_width_get(a, b)                                       \
  _gx_widget_border_width_get((GX_WIDGET *)a, b)
#define gx_widget_canvas_get(a, b) _gx_widget_canvas_get((GX_WIDGET *)a, b)
#define gx_widget_child_detect(a, b, c)                                        \
  _gx_widget_child_detect((GX_WIDGET *)a, b, c)
#define gx_widget_children_draw(a) _gx_widget_children_draw((GX_WIDGET *)a)
#define gx_widget_client_get(a, b, c)                                          \
  _gx_widget_client_get((GX_WIDGET *)a, b, c)
#define gx_widget_color_get(a, b, c) _gx_widget_color_get((GX_WIDGET *)a, b, c)
#define gx_widget_create(a, b, c, d, e, f)                                     \
  _gx_widget_create((GX_WIDGET *)a, b, (GX_WIDGET *)c, d, e, f)
...
#define gx_widget_draw_set(a, b)                                               \
  _gx_widget_draw_set((GX_WIDGET *)a, (void (*)(GX_WIDGET *))b)
#define gx_widget_event_generate(a, b, c)                                      \
  _gx_widget_event_generate((GX_WIDGET *)a, b, c)
#define gx_widget_event_process(a, b)                                          \
  _gx_widget_event_process((GX_WIDGET *)a, b)
#define gx_widget_event_process_set(a, b)                                      \
  _gx_widget_event_process_set((GX_WIDGET *)a,                                 \
                               (UINT(*)(GX_WIDGET *, GX_EVENT *))b)
#define gx_widget_event_to_parent(a, b)                                        \
  _gx_widget_event_to_parent((GX_WIDGET *)a, b)
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_widget_fill_color_set(a, b, c)                                      \
  _gx_widget_fill_color_set((GX_WIDGET *)a, b, c, b)
#else
#define gx_widget_fill_color_set(a, b, c, d)                                   \
  _gx_widget_fill_color_set((GX_WIDGET *)a, b, c, d)
#endif
#define gx_widget_find(a, b, c, d)                                             \
  _gx_widget_find((GX_WIDGET *)a, b, c, (GX_WIDGET **)d)
#define gx_widget_first_child_get(a, b)                                        \
  _gx_widget_first_child_get((GX_WIDGET *)a, (GX_WIDGET **)b)
...
#define gx_widget_last_child_get(a, b)                                         \
  _gx_widget_last_child_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_next_sibling_get(a, b)                                       \
  _gx_widget_next_sibling_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_parent_get(a, b)                                             \
  _gx_widget_parent_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_pixelmap_get(a, b, c)                                        \
  _gx_widget_pixelmap_get((GX_WIDGET *)a, b, c)
#define gx_widget_previous_sibling_get(a, b)                                   \
  _gx_widget_previous_sibling_get((GX_WIDGET *)a, (GX_WIDGET **)b)
...
#define gx_widget_status_remove(a, b)                                          \
  _gx_widget_status_remove((GX_WIDGET *)a, b)
#define gx_widget_status_test(a, b, c)                                         \
  _gx_widget_status_test((GX_WIDGET *)a, b, c)
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_widget_string_get(a, b, c)                                          \
  _gx_widget_string_get((GX_WIDGET *)a, b, c)
#endif
#define gx_widget_string_get_ext(a, b, c)                                      \
  _gx_widget_string_get_ext((GX_WIDGET *)a, b, c)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_widget_text_blend(a, b, c, d, e, f, g)                              \
  _gx_widget_text_blend((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_draw(a, b, c, d, e, f)                                  \
  _gx_widget_text_draw((GX_WIDGET *)a, b, c, d, e, f)
#endif
#define gx_widget_text_blend_ext(a, b, c, d, e, f, g)                          \
  _gx_widget_text_blend_ext((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_draw_ext(a, b, c, d, e, f)                              \
  _gx_widget_text_draw_ext((GX_WIDGET *)a, b, c, d, e, f)
#define gx_widget_text_id_draw(a, b, c, d, e, f)                               \
  _gx_widget_text_id_draw((GX_WIDGET *)a, b, c, d, e, f)
#define gx_widget_top_visible_child_find(a, b)                                 \
  _gx_widget_top_visible_child_find((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_type_find(a, b, c)                                           \
  _gx_widget_type_find((GX_WIDGET *)a, b, (GX_WIDGET **)c)
...
#define gx_window_create(a, b, c, d, e, f)                                     \
  _gx_window_create(a, b, (GX_WIDGET *)c, d, e, f)
...
#define gx_window_wallpaper_set(a, b, c)                                       \
  _gx_window_wallpaper_set((GX_WINDOW *)a, b, c)

/* Define the non-error checking function prototypes of the GUIX API.  These are
   the routines called when the application code is built with
   GX_DISABLE_ERROR_CHECKING defined.  */

UINT _gx_accordion_menu_create(GX_ACCORDION_MENU *accordion,
...
UINT _gx_accordion_menu_event_process(GX_ACCORDION_MENU *accordion,
                                      GX_EVENT *event_ptr);
...
UINT _gx_animation_drag_enable(GX_ANIMATION *animation, GX_WIDGET *widget,
                               GX_ANIMATION_INFO *info);
UINT _gx_animation_landing_speed_set(GX_ANIMATION *animation,
...
UINT _gx_binres_language_info_load(GX_UBYTE *root_address,
                                   GX_LANGUAGE_HEADER *put_info);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_binres_language_table_load(GX_UBYTE *root_address,
                                    GX_UBYTE ****returned_language_table);
#endif
UINT _gx_binres_language_table_load_ext(GX_UBYTE *root_address,
                                        GX_STRING ***returned_language_table);
UINT _gx_binres_theme_load(GX_UBYTE *root_address, INT theme_id,
                           GX_THEME **returned_theme);
UINT _gx_binres_pixelmap_load(GX_UBYTE *root_address, UINT map_index,
                              GX_PIXELMAP *pixelmap);
UINT _gx_binres_font_load(GX_UBYTE *root_address, UINT font_index,
                          GX_UBYTE *buffer, ULONG *buffer_size);

UINT _gx_brush_default(GX_BRUSH *brush);
UINT _gx_brush_define(GX_BRUSH *brush, GX_COLOR line_color, GX_COLOR fill_color,
                      UINT style);

VOID _gx_button_background_draw(GX_BUTTON *button);
UINT _gx_button_create(GX_BUTTON *button, GX_CONST GX_CHAR *name,
                       GX_WIDGET *parent, ULONG style, USHORT Id,
                       GX_CONST GX_RECTANGLE *size);
...
UINT _gx_canvas_arc_draw(INT xcenter, INT ycenter, UINT r, INT start_angle,
                         INT end_angle);
UINT _gx_canvas_block_move(GX_RECTANGLE *block, GX_VALUE x_shift,
                           GX_VALUE y_shift, GX_RECTANGLE *dirty);
UINT _gx_canvas_circle_draw(INT xcenter, INT ycenter, UINT r);
UINT _gx_canvas_create(GX_CANVAS *canvas, GX_CONST GX_CHAR *name,
                       GX_DISPLAY *display, UINT type, UINT width, UINT height,
...
UINT _gx_canvas_drawing_initiate(GX_CANVAS *canvas, GX_WIDGET *who,
...
UINT _gx_canvas_line_draw(GX_VALUE x_start, GX_VALUE y_start, GX_VALUE x_end,
                          GX_VALUE y_end);
UINT _gx_canvas_memory_define(GX_CANVAS *canvas, GX_COLOR *memory,
                              ULONG memsize);
...
UINT _gx_canvas_pie_draw(INT xcenter, INT ycenter, UINT r, INT start_angle,
                         INT end_angle);
...
UINT _gx_canvas_pixelmap_draw(GX_VALUE x_position, GX_VALUE y_position,
                              GX_PIXELMAP *pixelmap);
UINT _gx_canvas_pixelmap_get(GX_PIXELMAP *pixelmap);
UINT _gx_canvas_pixelmap_rotate(GX_VALUE x_position, GX_VALUE y_position,
                                GX_PIXELMAP *pixelmap, INT angle, INT rot_cx,
                                INT rot_cy);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_canvas_rotated_text_draw(GX_CONST GX_CHAR *text, GX_VALUE xcenter,
                                  GX_VALUE ycenter, INT angle);
#endif
UINT _gx_canvas_rotated_text_draw_ext(GX_CONST GX_STRING *text,
                                      GX_VALUE xcenter, GX_VALUE ycenter,
                                      INT angle);
UINT _gx_canvas_shift(GX_CANVAS *canvas, GX_VALUE x, GX_VALUE y);
UINT _gx_canvas_show(GX_CANVAS *canvas);

UINT _gx_canvas_aligned_text_draw(GX_CONST GX_STRING *string,
                                  GX_RECTANGLE *rectangle, ULONG alignment);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_canvas_text_draw(GX_VALUE x_start, GX_VALUE y_start,
                          GX_CONST GX_CHAR *string, INT length);
#endif
UINT _gx_canvas_text_draw_ext(GX_VALUE x_start, GX_VALUE y_start,
                              GX_CONST GX_STRING *string);

UINT _gx_checkbox_create(GX_CHECKBOX *checkbox, GX_CONST GX_CHAR *name,
                         GX_WIDGET *parent, GX_RESOURCE_ID text_id, ULONG style,
                         USHORT checkbox_id, GX_CONST GX_RECTANGLE *size);
VOID _gx_checkbox_draw(GX_CHECKBOX *checkbox);
UINT _gx_checkbox_event_process(GX_CHECKBOX *checkbox, GX_EVENT *event_ptr);
UINT _gx_checkbox_pixelmap_set(GX_CHECKBOX *button, GX_RESOURCE_ID unchecked_id,
...
UINT _gx_circular_gauge_angle_get(GX_CIRCULAR_GAUGE *circular_gauge,
                                  INT *angle);
UINT _gx_circular_gauge_angle_set(GX_CIRCULAR_GAUGE *circular_gauge, INT angle);
UINT _gx_circular_gauge_animation_set(GX_CIRCULAR_GAUGE *circular_gauge,
                                      INT steps, INT delay);
...
UINT _gx_circular_gauge_create(GX_CIRCULAR_GAUGE *circular_gauge,
                               ...
                               GX_RESOURCE_ID background, ULONG style,
                               USHORT circular_gauge_id, GX_VALUE xpos,
                               GX_VALUE ypos);
VOID _gx_circular_gauge_draw(GX_CIRCULAR_GAUGE *circular_gauge);
UINT _gx_circular_gauge_event_process(GX_CIRCULAR_GAUGE *circular_gauge,
                                      GX_EVENT *event_ptr);

UINT _gx_context_brush_default(GX_DRAW_CONTEXT *context);
UINT _gx_context_brush_define(GX_RESOURCE_ID line_color_id,
                              GX_RESOURCE_ID fill_color_id, UINT style);
...
UINT _gx_context_pixelmap_get(GX_RESOURCE_ID pixelmap_id,
                              GX_PIXELMAP **return_pixelmap);
UINT _gx_context_pixelmap_set(GX_RESOURCE_ID pixelmap_id);
UINT _gx_context_raw_brush_define(GX_COLOR line_color, GX_COLOR fill_color,
                                  UINT style);
UINT _gx_context_raw_fill_color_set(GX_COLOR line_color);
UINT _gx_context_raw_line_color_set(GX_COLOR line_color);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_context_string_get(GX_RESOURCE_ID string_id,
                            GX_CONST GX_CHAR **return_string);
#endif
UINT _gx_context_string_get_ext(GX_RESOURCE_ID string_id,
                                GX_STRING *return_string);

UINT _gx_display_active_language_set(GX_DISPLAY *display, GX_UBYTE language);
UINT _gx_display_color_set(GX_DISPLAY *display, GX_RESOURCE_ID resource_id,
                           GX_COLOR new_color);
UINT _gx_display_color_table_set(GX_DISPLAY *display, GX_COLOR *color_table,
...
UINT _gx_display_delete(GX_DISPLAY *display,
                        VOID (*display_driver_cleanup)(GX_DISPLAY *));
UINT _gx_display_font_table_set(GX_DISPLAY *display, GX_FONT **font_table,
                                UINT number_of_fonts);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_display_language_table_get(GX_DISPLAY *display, GX_CHAR ****table,
                                    GX_UBYTE *language_count,
                                    UINT *string_count);
UINT _gx_display_language_table_set(GX_DISPLAY *display, GX_CHAR ***table,
                                    GX_UBYTE num_languages,
                                    UINT number_of_strings);
#endif
UINT _gx_display_language_table_get_ext(GX_DISPLAY *display, GX_STRING ***table,
                                        GX_UBYTE *language_count,
                                        UINT *string_count);
UINT _gx_display_language_table_set_ext(GX_DISPLAY *display,
                                        GX_CONST GX_STRING **table,
                                        GX_UBYTE num_languages,
                                        UINT number_of_strings);
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
UINT _gx_display_language_direction_table_set(
    GX_DISPLAY *display, GX_CONST GX_UBYTE *language_direction_table,
    GX_UBYTE num_languages);
#endif
UINT _gx_display_pixelmap_table_set(GX_DISPLAY *display,
                                    GX_PIXELMAP **pixelmap_table,
                                    UINT number_of_pixelmaps);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_display_string_get(GX_DISPLAY *display, GX_RESOURCE_ID string_id,
                            GX_CONST GX_CHAR **return_string);
UINT _gx_display_string_table_get(GX_DISPLAY *display, GX_UBYTE language,
                                  GX_CHAR ***table, UINT *size);
#endif
UINT _gx_display_string_get_ext(GX_DISPLAY *display, GX_RESOURCE_ID string_id,
                                GX_STRING *return_string);
UINT _gx_display_string_table_get_ext(GX_DISPLAY *display, GX_UBYTE language,
                                      GX_STRING **table, UINT *size);
...
UINT _gx_drop_list_create(GX_DROP_LIST *drop_list, GX_CONST GX_CHAR *name,
                          ...
                          VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *,
                                           INT),
...
UINT _gx_drop_list_pixelmap_set(GX_DROP_LIST *drop_list,
                                GX_RESOURCE_ID pixelmap_id);
UINT _gx_drop_list_popup_get(GX_DROP_LIST *box, GX_VERTICAL_LIST **return_list);

UINT _gx_generic_scroll_wheel_create(
    GX_GENERIC_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT total_rows,
    VOID (*callback)(GX_GENERIC_SCROLL_WHEEL *, GX_WIDGET *, INT), ULONG style,
    USHORT id, GX_CONST GX_RECTANGLE *size);
UINT _gx_generic_scroll_wheel_children_position(GX_GENERIC_SCROLL_WHEEL *wheel);
UINT _gx_generic_scroll_wheel_event_process(GX_GENERIC_SCROLL_WHEEL *wheel,
                                            GX_EVENT *event_ptr);
UINT _gx_generic_scroll_wheel_row_height_set(GX_GENERIC_SCROLL_WHEEL *wheel,
                                             GX_VALUE row_height);
UINT _gx_generic_scroll_wheel_total_rows_set(GX_GENERIC_SCROLL_WHEEL *wheel,
                                             INT count);

UINT _gx_horizontal_list_children_position(GX_HORIZONTAL_LIST *horizontal_list);
UINT _gx_horizontal_list_create(
    GX_HORIZONTAL_LIST *horizontal_list, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, INT total_columns,
    VOID (*callback)(GX_HORIZONTAL_LIST *, GX_WIDGET *, INT), ULONG style,
    USHORT horizontal_list_id, GX_CONST GX_RECTANGLE *size);
UINT _gx_horizontal_list_event_process(GX_HORIZONTAL_LIST *list,
                                       GX_EVENT *event_ptr);
...
UINT _gx_horizontal_list_selected_index_get(GX_HORIZONTAL_LIST *horizontal_list,
                                            INT *return_index);
UINT _gx_horizontal_list_selected_set(GX_HORIZONTAL_LIST *horizontal_list,
                                      INT index);
UINT _gx_horizontal_list_selected_widget_get(
    GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET **return_list_entry);
UINT _gx_horizontal_list_total_columns_set(GX_HORIZONTAL_LIST *horizontal_list,
                                           INT count);

UINT _gx_horizontal_scrollbar_create(GX_SCROLLBAR *scrollbar,
                                     GX_CONST GX_CHAR *name, GX_WINDOW *parent,
                                     GX_SCROLLBAR_APPEARANCE *appearance,
                                     ULONG style);

VOID _gx_icon_background_draw(GX_ICON *icon);
UINT _gx_icon_button_create(GX_ICON_BUTTON *button, GX_CONST GX_CHAR *name,
...
UINT _gx_icon_pixelmap_set(GX_ICON *icon, GX_RESOURCE_ID normal_id,
                           GX_RESOURCE_ID selected_id);

UINT _gx_image_reader_create(GX_IMAGE_READER *image_reader,
                             GX_CONST GX_UBYTE *read_data, INT read_data_size,
                             GX_UBYTE color_format, GX_UBYTE mode);
UINT _gx_image_reader_palette_set(GX_IMAGE_READER *image_reader, GX_COLOR *pal,
                                  UINT palsize);
...
UINT _gx_line_chart_create(GX_LINE_CHART *chart, GX_CONST GX_CHAR *name,
                           GX_WIDGET *parent, GX_CONST GX_LINE_CHART_INFO *info,
                           ULONG style, USHORT chart_id,
                           GX_CONST GX_RECTANGLE *size);
...
UINT _gx_menu_text_offset_set(GX_MENU *menu, GX_VALUE x_offset,
                              GX_VALUE y_offset);

UINT _gx_multi_line_text_button_create(GX_MULTI_LINE_TEXT_BUTTON *button,
                                       GX_CONST GX_CHAR *name,
                                       GX_WIDGET *parent,
                                       GX_RESOURCE_ID text_id, ULONG style,
                                       USHORT Id, GX_CONST GX_RECTANGLE *size);
VOID _gx_multi_line_text_button_draw(GX_MULTI_LINE_TEXT_BUTTON *button);
UINT _gx_multi_line_text_button_event_process(GX_MULTI_LINE_TEXT_BUTTON *button,
                                              GX_EVENT *event_ptr);
VOID _gx_multi_line_text_button_text_draw(GX_MULTI_LINE_TEXT_BUTTON *button);
UINT _gx_multi_line_text_button_text_id_set(GX_MULTI_LINE_TEXT_BUTTON *button,
                                            GX_RESOURCE_ID string_id);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_multi_line_text_button_text_set(GX_MULTI_LINE_TEXT_BUTTON *button,
                                         GX_CONST GX_CHAR *text);
#endif
UINT _gx_multi_line_text_button_text_set_ext(GX_MULTI_LINE_TEXT_BUTTON *button,
                                             GX_CONST GX_STRING text);

UINT _gx_multi_line_text_input_backspace(GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gx_multi_line_text_input_buffer_clear(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr);
UINT _gx_multi_line_text_input_buffer_get(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, GX_CHAR **buffer_address,
    UINT *content_size, UINT *buffer_size);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_multi_line_text_input_char_insert(GX_MULTI_LINE_TEXT_INPUT *text_input,
                                           GX_UBYTE *str, UINT str_size);
#endif
UINT _gx_multi_line_text_input_char_insert_ext(
    GX_MULTI_LINE_TEXT_INPUT *text_input, GX_CONST GX_STRING *str);
UINT _gx_multi_line_text_input_create(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr,
                                      GX_CONST GX_CHAR *name_ptr,
                                      GX_WIDGET *parent, GX_CHAR *input_buffer,
                                      UINT buffer_size, ULONG style, USHORT Id,
                                      GX_CONST GX_RECTANGLE *size);
UINT _gx_multi_line_text_input_cursor_pos_get(GX_MULTI_LINE_TEXT_INPUT *input,
                                              GX_POINT *cursor_pos);
...
UINT _gx_multi_line_text_input_event_process(GX_MULTI_LINE_TEXT_INPUT *input,
                                             GX_EVENT *event_ptr);
UINT _gx_multi_line_text_input_style_add(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gx_multi_line_text_input_style_remove(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gx_multi_line_text_input_style_set(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
...
UINT _gx_multi_line_text_input_right_arrow(
...
UINT _gx_multi_line_text_input_text_color_set(GX_MULTI_LINE_TEXT_INPUT *view,
                                              ...
                                              GX_RESOURCE_ID disabled_id,
                                              GX_RESOURCE_ID readonly_id);
UINT _gx_multi_line_text_input_text_select(GX_MULTI_LINE_TEXT_INPUT *input,
                                           UINT start_index, UINT end_index);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_multi_line_text_input_text_set(GX_MULTI_LINE_TEXT_INPUT *text_input,
                                        GX_CONST GX_CHAR *text);
#endif
UINT _gx_multi_line_text_input_text_set_ext(
    GX_MULTI_LINE_TEXT_INPUT *text_input, GX_CONST GX_STRING *text);
...
UINT _gx_multi_line_text_view_event_process(GX_MULTI_LINE_TEXT_VIEW *view,
                                            GX_EVENT *event_ptr);
UINT _gx_multi_line_text_view_font_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                       GX_RESOURCE_ID font_id);
UINT _gx_multi_line_text_view_line_space_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                             GX_BYTE line_space);
UINT _gx_multi_line_text_view_scroll_info_get(
    GX_MULTI_LINE_TEXT_VIEW *view, ULONG style,
    GX_SCROLL_INFO *return_scroll_info);
UINT _gx_multi_line_text_view_text_color_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                             GX_RESOURCE_ID normal_id,
                                             GX_RESOURCE_ID selected_id,
                                             GX_RESOURCE_ID disabled_id);
UINT _gx_multi_line_text_view_text_id_set(
    GX_MULTI_LINE_TEXT_VIEW *text_view_ptr, GX_RESOURCE_ID text_id);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_multi_line_text_view_text_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                       GX_CONST GX_CHAR *text);
#endif
UINT _gx_multi_line_text_view_text_set_ext(GX_MULTI_LINE_TEXT_VIEW *view,
                                           GX_CONST GX_STRING *text);
UINT _gx_multi_line_text_view_whitespace_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                             GX_UBYTE whitespace);

UINT _gx_rich_text_view_create(GX_RICH_TEXT_VIEW *rich_view,
                               GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                               GX_RESOURCE_ID text_id,
                               GX_RICH_TEXT_FONTS *fonts, ULONG style,
                               USHORT id, GX_CONST GX_RECTANGLE *size);
VOID _gx_rich_text_view_draw(GX_RICH_TEXT_VIEW *text_view);
VOID _gx_rich_text_view_text_draw(GX_RICH_TEXT_VIEW *text_view);
UINT _gx_rich_text_view_fonts_set(GX_RICH_TEXT_VIEW *rich_view,
                                  GX_RICH_TEXT_FONTS *fonts);

UINT _gx_numeric_pixelmap_prompt_create(
    GX_NUMERIC_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, GX_RESOURCE_ID text_id, GX_RESOURCE_ID fill_id,
    ULONG style, USHORT pixelmap_prompt_id, GX_CONST GX_RECTANGLE *size);
UINT _gx_numeric_pixelmap_prompt_format_function_set(
    GX_NUMERIC_PIXELMAP_PROMPT *prompt,
    VOID (*format_func)(GX_NUMERIC_PIXELMAP_PROMPT *, INT));
UINT _gx_numeric_pixelmap_prompt_value_set(GX_NUMERIC_PIXELMAP_PROMPT *prompt,
                                           INT value);

UINT _gx_numeric_prompt_create(GX_NUMERIC_PROMPT *prompt,
                               GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                               GX_RESOURCE_ID text_id, ULONG style,
                               USHORT prompt_id, GX_CONST GX_RECTANGLE *size);
UINT _gx_numeric_prompt_format_function_set(
    GX_NUMERIC_PROMPT *prompt, VOID (*format_func)(GX_NUMERIC_PROMPT *, INT));
...
UINT _gx_numeric_scroll_wheel_create(GX_NUMERIC_SCROLL_WHEEL *wheel,
                                     GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                     INT start_val, INT end_val, ULONG style,
                                     USHORT Id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_pixelmap_button_create(GX_PIXELMAP_BUTTON *button,
                                ...
                                GX_RESOURCE_ID normal_id,
                                GX_RESOURCE_ID selected_id,
                                GX_RESOURCE_ID disabled_id, ULONG style,
                                USHORT pixelmap_button_id,
                                GX_CONST GX_RECTANGLE *size);
VOID _gx_pixelmap_button_draw(GX_PIXELMAP_BUTTON *button);
UINT _gx_pixelmap_button_event_process(GX_PIXELMAP_BUTTON *button,
                                       GX_EVENT *event_ptr);
...
UINT _gx_pixelmap_prompt_create(GX_PIXELMAP_PROMPT *prompt,
                                GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                GX_RESOURCE_ID text_id,
                                GX_RESOURCE_ID normal_fill_id, ULONG style,
                                USHORT prompt_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_pixelmap_slider_event_process(GX_PIXELMAP_SLIDER *slider,
                                       GX_EVENT *event_ptr);
UINT _gx_pixelmap_slider_pixelmap_set(GX_PIXELMAP_SLIDER *slider,
                                      GX_PIXELMAP_SLIDER_INFO *info);
...
UINT _gx_progress_bar_event_process(GX_PROGRESS_BAR *progress_bar,
                                    GX_EVENT *event_ptr);
UINT _gx_progress_bar_font_set(GX_PROGRESS_BAR *progress_bar,
                               GX_RESOURCE_ID font_id);
UINT _gx_progress_bar_info_set(GX_PROGRESS_BAR *progress_bar,
                               GX_PROGRESS_BAR_INFO *info);
UINT _gx_progress_bar_pixelmap_set(GX_PROGRESS_BAR *progress_bar,
                                   GX_RESOURCE_ID pixelmap);
UINT _gx_progress_bar_range_set(GX_PROGRESS_BAR *progress_bar, INT min_value,
                                INT max_value);
...
UINT _gx_radial_progress_bar_anchor_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                        GX_VALUE angle);
VOID _gx_radial_progress_bar_background_draw(
    GX_RADIAL_PROGRESS_BAR *progress_bar);
UINT _gx_radial_progress_bar_create(
    GX_RADIAL_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, GX_RADIAL_PROGRESS_BAR_INFO *progress_bar_info,
    ULONG style, USHORT progress_bar_id);
VOID _gx_radial_progress_bar_draw(GX_RADIAL_PROGRESS_BAR *progress_bar);
UINT _gx_radial_progress_bar_event_process(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                           GX_EVENT *event_ptr);
UINT _gx_radial_progress_bar_font_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                      GX_RESOURCE_ID font_id);
UINT _gx_radial_progress_bar_info_set(GX_RADIAL_PROGRESS_BAR *bar,
                                      GX_RADIAL_PROGRESS_BAR_INFO *info);
UINT _gx_radial_progress_bar_text_color_set(
    GX_RADIAL_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID normal_text_color_id,
    GX_RESOURCE_ID selected_text_color_id,
    GX_RESOURCE_ID disabled_text_color_id);
VOID _gx_radial_progress_bar_text_draw(GX_RADIAL_PROGRESS_BAR *bar);
UINT _gx_radial_progress_bar_value_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                       GX_VALUE new_value);

UINT _gx_radial_slider_anchor_angles_set(GX_RADIAL_SLIDER *slider,
                                         GX_VALUE *anchor_angles,
                                         USHORT anchor_count);
UINT _gx_radial_slider_animation_set(
    GX_RADIAL_SLIDER *slider, USHORT steps, USHORT delay,
    USHORT animation_style,
    VOID (*animation_update_callback)(GX_RADIAL_SLIDER *slider));
UINT _gx_radial_slider_animation_start(GX_RADIAL_SLIDER *slider,
                                       GX_VALUE new_value);
UINT _gx_radial_slider_create(GX_RADIAL_SLIDER *slider, GX_CONST GX_CHAR *name,
...
UINT _gx_radial_slider_event_process(GX_RADIAL_SLIDER *slider,
                                     GX_EVENT *event_ptr);
UINT _gx_radial_slider_info_get(GX_RADIAL_SLIDER *slider,
                                GX_RADIAL_SLIDER_INFO **info);
UINT _gx_radial_slider_info_set(GX_RADIAL_SLIDER *slider,
                                GX_RADIAL_SLIDER_INFO *info);
...
UINT _gx_scroll_wheel_create(GX_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name,
                             GX_WIDGET *parent, INT total_rows, ULONG style,
                             USHORT Id, GX_CONST GX_RECTANGLE *size);
UINT _gx_scroll_wheel_event_process(GX_SCROLL_WHEEL *wheel,
                                    GX_EVENT *event_ptr);
UINT _gx_scroll_wheel_gradient_alpha_set(GX_SCROLL_WHEEL *wheel,
                                         GX_UBYTE start_alpha,
                                         GX_UBYTE end_alpha);
UINT _gx_scroll_wheel_row_height_set(GX_SCROLL_WHEEL *wheel,
                                     GX_VALUE row_height);
UINT _gx_scroll_wheel_selected_background_set(GX_SCROLL_WHEEL *wheel,
                                              GX_RESOURCE_ID selected_bg);
...
UINT _gx_scroll_wheel_speed_set(GX_SCROLL_WHEEL *wheel,
                                ...
                                GX_FIXED_VAL end_speed_rate, GX_VALUE max_steps,
                                GX_VALUE delay);
UINT _gx_scroll_wheel_total_rows_set(GX_SCROLL_WHEEL *wheel, INT total_rows);

UINT _gx_single_line_text_input_backspace(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_buffer_clear(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_buffer_get(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CHAR **buffer_address,
    UINT *content_size, UINT *buffer_size);
UINT _gx_single_line_text_input_character_delete(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_character_insert(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_UBYTE *str, UINT str_size);
UINT _gx_single_line_text_input_create(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name,
...
UINT _gx_single_line_text_input_draw_position_get(
    GX_SINGLE_LINE_TEXT_INPUT *input, GX_VALUE *xpos, GX_VALUE *ypos);
UINT _gx_single_line_text_input_end(GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_event_process(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_EVENT *event_ptr);
UINT _gx_single_line_text_input_fill_color_set(
    GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_fill_color_id,
...
UINT _gx_single_line_text_input_left_arrow(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_position_get(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, INT pixel_position);
UINT _gx_single_line_text_input_right_arrow(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gx_single_line_text_input_style_add(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gx_single_line_text_input_style_remove(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gx_single_line_text_input_style_set(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gx_single_line_text_input_text_color_set(
    GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_text_color_id,
    GX_RESOURCE_ID selected_text_color_id,
    GX_RESOURCE_ID disabled_text_color_id,
    GX_RESOURCE_ID readonly_text_color_id);
UINT _gx_single_line_text_input_text_select(GX_SINGLE_LINE_TEXT_INPUT *input,
                                            UINT start_index, UINT end_index);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_single_line_text_input_text_set(GX_SINGLE_LINE_TEXT_INPUT *input,
                                         GX_CONST GX_CHAR *text);
#endif
UINT _gx_single_line_text_input_text_set_ext(GX_SINGLE_LINE_TEXT_INPUT *input,
                                             GX_CONST GX_STRING *text);
...
UINT _gx_slider_needle_position_get(GX_SLIDER *slider,
                                    GX_SLIDER_INFO *slider_info,
                                    GX_RECTANGLE *return_position);
VOID _gx_slider_tickmarks_draw(GX_SLIDER *slider);
UINT _gx_slider_travel_get(GX_SLIDER *widget, GX_SLIDER_INFO *info,
                           INT *mintravel, INT *maxtravel);
UINT _gx_slider_value_calculate(GX_SLIDER *slider, GX_SLIDER_INFO *info,
                                INT newpos);
UINT _gx_slider_value_set(GX_SLIDER *slider, GX_SLIDER_INFO *info,
                          INT new_value);

UINT _gx_sprite_create(GX_SPRITE *sprite, GX_CONST GX_CHAR *name,
                       GX_WIDGET *parent, GX_SPRITE_FRAME *frame_list,
                       USHORT framecount, ULONG style, USHORT sprite_id,
                       GX_CONST GX_RECTANGLE *size);
UINT _gx_sprite_current_frame_set(GX_SPRITE *sprite, USHORT frame);
UINT _gx_sprite_frame_list_set(GX_SPRITE *sprite, GX_SPRITE_FRAME *frame_list,
                               USHORT frame_count);
...
UINT _gx_string_scroll_wheel_create(GX_STRING_SCROLL_WHEEL *wheel,
                                    GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                    INT total_rows,
                                    GX_CONST GX_CHAR **string_list, ULONG style,
                                    USHORT Id, GX_CONST GX_RECTANGLE *size);
#endif
UINT _gx_string_scroll_wheel_create_ext(GX_STRING_SCROLL_WHEEL *wheel,
                                        ...
                                        ULONG style, USHORT Id,
                                        GX_CONST GX_RECTANGLE *size);
UINT _gx_string_scroll_wheel_event_process(GX_STRING_SCROLL_WHEEL *wheel,
                                           GX_EVENT *event_ptr);
UINT _gx_string_scroll_wheel_string_id_list_set(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_RESOURCE_ID *string_id_list,
    INT id_count);
...
UINT _gx_string_scroll_wheel_string_list_set(GX_STRING_SCROLL_WHEEL *wheel,
                                             ...
                                             INT string_count);
#endif
UINT _gx_string_scroll_wheel_string_list_set_ext(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_STRING *string_list,
    INT string_count);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_system_language_table_get(GX_CHAR ****language_table,
                                   GX_UBYTE *languages_count,
                                   UINT *string_count);
UINT _gx_system_language_table_set(GX_CHAR ***language_table,
                                   GX_UBYTE number_of_languages,
                                   UINT number_of_strings);
#endif

UINT _gx_system_memory_allocator_set(VOID *(*allocate)(ULONG size),
                                     VOID (*release)(VOID *));
...
UINT _gx_system_screen_stack_get(GX_WIDGET **popped_parent,
                                 GX_WIDGET **popped_screen);
UINT _gx_system_screen_stack_reset(VOID);
UINT _gx_system_scroll_appearance_get(ULONG style,
                                      GX_SCROLLBAR_APPEARANCE *appearance);
UINT _gx_system_scroll_appearance_set(ULONG style,
                                      GX_SCROLLBAR_APPEARANCE *appearance);
UINT _gx_system_start(VOID);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_system_string_get(GX_RESOURCE_ID string_id,
                           GX_CONST GX_CHAR **return_string);
UINT _gx_system_string_table_get(GX_UBYTE language, GX_CHAR ***get_table,
                                 UINT *get_size);
UINT _gx_system_string_width_get(GX_CONST GX_FONT *font,
                                 GX_CONST GX_CHAR *string, INT string_length,
                                 GX_VALUE *return_width);
#endif
UINT _gx_system_string_width_get_ext(GX_CONST GX_FONT *font,
                                     GX_CONST GX_STRING *string,
                                     GX_VALUE *return_width);
UINT _gx_system_timer_start(GX_WIDGET *owner, UINT timer_id, UINT initial_ticks,
...
UINT _gx_system_widget_find(USHORT widget_id, INT search_level,
...
UINT _gx_text_button_text_get(GX_TEXT_BUTTON *button,
                              GX_CONST GX_CHAR **return_text);
UINT _gx_text_button_text_id_set(GX_TEXT_BUTTON *button,
                                 GX_RESOURCE_ID string_id);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_text_button_text_set(GX_TEXT_BUTTON *button, GX_CONST GX_CHAR *text);
#endif
UINT _gx_text_button_text_set_ext(GX_TEXT_BUTTON *button,
                                  GX_CONST GX_STRING *text);

UINT _gx_text_input_cursor_blink_interval_set(
    GX_TEXT_INPUT_CURSOR *cursor_input, GX_UBYTE blink_interval);
UINT _gx_text_input_cursor_height_set(GX_TEXT_INPUT_CURSOR *cursor_input,
                                      GX_UBYTE height);
UINT _gx_text_input_cursor_width_set(GX_TEXT_INPUT_CURSOR *cursor_input,
                                     GX_UBYTE width);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_text_scroll_wheel_callback_set(
    GX_TEXT_SCROLL_WHEEL *wheel,
    GX_CONST GX_CHAR *(*callback)(GX_TEXT_SCROLL_WHEEL *, INT));
#endif
UINT _gx_text_scroll_wheel_callback_set_ext(
    GX_TEXT_SCROLL_WHEEL *wheel,
...
UINT _gx_text_scroll_wheel_event_process(GX_TEXT_SCROLL_WHEEL *wheel,
                                         GX_EVENT *event_ptr);
...
UINT _gx_tree_view_create(GX_TREE_VIEW *tree, GX_CONST GX_CHAR *name,
                          GX_WIDGET *parent, ULONG style, USHORT tree_view_id,
                          GX_CONST GX_RECTANGLE *size);
...
UINT _gx_tree_view_root_line_color_set(GX_TREE_VIEW *tree,
                                       GX_RESOURCE_ID color);
UINT _gx_tree_view_root_pixelmap_set(GX_TREE_VIEW *tree,
...
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
UINT _gx_utility_bidi_paragraph_reorder(
    GX_BIDI_TEXT_INFO *input_info,
    GX_BIDI_RESOLVED_TEXT_INFO **resolved_info_head);
UINT _gx_utility_bidi_paragraph_reorder_ext(
    GX_BIDI_TEXT_INFO *input_info,
    GX_BIDI_RESOLVED_TEXT_INFO **resolved_info_head);
...
UINT _gx_utility_canvas_to_bmp(GX_CANVAS *canvas, GX_RECTANGLE *rect,
                               UINT (*write_data)(GX_UBYTE *byte_data,
                                                  UINT data_count));
UINT _gx_utility_gradient_create(GX_GRADIENT *gradient, GX_VALUE width,
                                 GX_VALUE height, UCHAR type,
                                 GX_UBYTE start_alpha, GX_UBYTE end_alpha);
UINT _gx_utility_gradient_delete(GX_GRADIENT *gradient);

UINT _gx_utility_circle_point_get(INT xcenter, INT ycenter, UINT r, INT angle,
                                  GX_POINT *point);
UINT _gx_utility_ltoa(LONG value, GX_CHAR *return_buffer,
...
UINT _gx_utility_pixelmap_resize(GX_PIXELMAP *src, GX_PIXELMAP *destination,
                                 INT width, INT height);
UINT _gx_utility_pixelmap_rotate(GX_PIXELMAP *src, INT angle,
                                 GX_PIXELMAP *destination, INT *rot_cx,
                                 INT *rot_cy);
UINT _gx_utility_pixelmap_simple_rotate(GX_PIXELMAP *src, INT angle,
                                        GX_PIXELMAP *destination, INT *rot_cx,
                                        INT *rot_cy);
UINT _gx_utility_rectangle_center(GX_RECTANGLE *rectangle,
                                  GX_RECTANGLE *within);
UINT _gx_utility_rectangle_center_find(GX_RECTANGLE *rectangle,
                                       GX_POINT *return_center);
UINT _gx_utility_rectangle_combine(GX_RECTANGLE *first_rectangle,
                                   GX_RECTANGLE *second_rectangle);
GX_BOOL _gx_utility_rectangle_compare(GX_RECTANGLE *first_rectangle,
                                      GX_RECTANGLE *second_rectangle);
UINT _gx_utility_rectangle_define(GX_RECTANGLE *rectangle, GX_VALUE left,
                                  GX_VALUE top, GX_VALUE right,
                                  GX_VALUE bottom);
GX_BOOL _gx_utility_rectangle_overlap_detect(GX_RECTANGLE *first_rectangle,
                                             GX_RECTANGLE *second_rectangle,
                                             GX_RECTANGLE *return_overlap_area);
GX_BOOL _gx_utility_rectangle_point_detect(GX_RECTANGLE *rectangle,
                                           GX_POINT point);
UINT _gx_utility_rectangle_resize(GX_RECTANGLE *rectangle, GX_VALUE adjust);
UINT _gx_utility_rectangle_shift(GX_RECTANGLE *rectangle, GX_VALUE x_shift,
                                 GX_VALUE y_shift);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_utility_string_to_alphamap(GX_CONST GX_CHAR *text,
                                    GX_CONST GX_FONT *font,
                                    GX_PIXELMAP *textmap);
#endif
UINT _gx_utility_string_to_alphamap_ext(GX_CONST GX_STRING *text,
                                        GX_CONST GX_FONT *font,
                                        GX_PIXELMAP *textmap);

UINT _gx_vertical_list_children_position(GX_VERTICAL_LIST *vertical_list);
UINT _gx_vertical_list_create(
    GX_VERTICAL_LIST *vertical_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT total_rows, VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *, INT),
    ULONG style, USHORT vertical_list_id, GX_CONST GX_RECTANGLE *size);
UINT _gx_vertical_list_event_process(GX_VERTICAL_LIST *list,
                                     GX_EVENT *event_ptr);
...
UINT _gx_vertical_scrollbar_create(GX_SCROLLBAR *scrollbar,
                                   GX_CONST GX_CHAR *name, GX_WINDOW *parent,
...
UINT _gx_widget_block_move(GX_WIDGET *widget, GX_RECTANGLE *block, INT x_shift,
                           INT y_shift);
VOID _gx_widget_border_draw(GX_WIDGET *widget, GX_RESOURCE_ID border_color,
                            GX_RESOURCE_ID upper_color, GX_COLOR lower_color,
                            GX_BOOL fill);
...
UINT _gx_widget_child_detect(GX_WIDGET *parent, GX_WIDGET *child,
                             GX_BOOL *return_detect);
VOID _gx_widget_children_draw(GX_WIDGET *widget);
UINT _gx_widget_client_get(GX_WIDGET *widget, GX_VALUE border_width,
                           GX_RECTANGLE *return_size);
UINT _gx_widget_color_get(GX_WIDGET *widget, GX_RESOURCE_ID color_id,
                          GX_COLOR *return_color);
UINT _gx_widget_create(GX_WIDGET *widget, GX_CONST GX_CHAR *name,
                       GX_WIDGET *parent, ULONG style, USHORT Id,
                       GX_CONST GX_RECTANGLE *size);
...
UINT _gx_widget_event_generate(GX_WIDGET *widget, USHORT event_type,
                               LONG value);
UINT _gx_widget_event_process(GX_WIDGET *widget, GX_EVENT *event_ptr);
UINT _gx_widget_event_process_set(
    GX_WIDGET *widget,
    UINT (*event_processing_function)(GX_WIDGET *, GX_EVENT *));
UINT _gx_widget_event_to_parent(GX_WIDGET *widget, GX_EVENT *event_ptr);
UINT _gx_widget_fill_color_set(GX_WIDGET *widget, GX_RESOURCE_ID normal_color,
                               GX_RESOURCE_ID selected_color,
                               GX_RESOURCE_ID disabled_color);
UINT _gx_widget_find(GX_WIDGET *parent, USHORT widget_id, INT search_depth,
                     GX_WIDGET **return_widget);
UINT _gx_widget_first_child_get(GX_WIDGET *parent, GX_WIDGET **child_return);
UINT _gx_widget_font_get(GX_WIDGET *widget, GX_RESOURCE_ID font_id,
                         GX_FONT **return_font);
...
UINT _gx_widget_next_sibling_get(GX_WIDGET *current,
                                 GX_WIDGET **sibling_return);
UINT _gx_widget_parent_get(GX_WIDGET *current, GX_WIDGET **parent_return);
UINT _gx_widget_pixelmap_get(GX_WIDGET *widget, GX_RESOURCE_ID font_id,
                             GX_PIXELMAP **return_pixelmap);
UINT _gx_widget_previous_sibling_get(GX_WIDGET *current,
                                     GX_WIDGET **sibling_return);
UINT _gx_widget_resize(GX_WIDGET *widget, GX_RECTANGLE *newsize);
UINT _gx_widget_shift(GX_WIDGET *widget, GX_VALUE x_shift, GX_VALUE y_shift,
                      GX_BOOL mark_dirty);
...
UINT _gx_widget_status_test(GX_WIDGET *widget, ULONG status,
                            GX_BOOL *return_test);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_widget_string_get(GX_WIDGET *widget, GX_RESOURCE_ID string_id,
                           GX_CONST GX_CHAR **return_string);
#endif
UINT _gx_widget_string_get_ext(GX_WIDGET *widget, GX_RESOURCE_ID string_id,
                               GX_STRING *return_string);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_widget_text_blend(GX_WIDGET *widget, UINT tColor, UINT font_id,
                           GX_CONST GX_CHAR *string, INT x_offset, INT y_offset,
                           UCHAR alpha);

VOID _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id,
                          GX_CONST GX_CHAR *string, INT x_offset, INT y_offset);
#endif
UINT _gx_widget_text_blend_ext(GX_WIDGET *widget, UINT tColor, UINT font_id,
                               GX_CONST GX_STRING *string, INT x_offset,
...
UINT _gx_widget_top_visible_child_find(GX_WIDGET *parent,
                                       GX_WIDGET **child_return);
UINT _gx_widget_type_find(GX_WIDGET *parent, USHORT widget_type,
                          GX_WIDGET **return_widget);
...
UINT _gx_window_client_scroll(GX_WINDOW *window, GX_VALUE x_scroll,
                              GX_VALUE y_scroll);
UINT _gx_window_client_width_get(GX_WINDOW *window, GX_VALUE *return_width);
UINT _gx_window_close(GX_WINDOW *window);
UINT _gx_window_create(GX_WINDOW *window, GX_CONST GX_CHAR *name,
                       GX_WIDGET *parent, ULONG style, USHORT window_id,
                       GX_CONST GX_RECTANGLE *size);
...
UINT _gx_window_root_find(GX_WIDGET *widget,
                          GX_WINDOW_ROOT **return_root_window);
UINT _gx_window_scroll_info_get(GX_WINDOW *window, ULONG type,
                                GX_SCROLL_INFO *return_scroll_info);
UINT _gx_window_scrollbar_find(GX_WINDOW *window, USHORT type,
                               GX_SCROLLBAR **return_scrollbar);
UINT _gx_window_wallpaper_get(GX_WINDOW *window,
                              GX_RESOURCE_ID *return_wallpaper_id);
UINT _gx_window_wallpaper_set(GX_WINDOW *window, GX_RESOURCE_ID wallpaper_id,
                              GX_BOOL tile);
...
#define gx_button_background_draw _gx_button_background_draw
#define gx_button_create(a, b, c, d, e, f)                                     \
  _gxe_button_create(a, b, (GX_WIDGET *)c, d, e, f, sizeof(GX_BUTTON))
...
#define gx_canvas_create(a, b, c, d, e, f, g, h)                               \
  _gxe_canvas_create(a, b, c, d, e, f, g, h, sizeof(GX_CANVAS))
#define gx_canvas_delete _gxe_canvas_delete
#define gx_canvas_drawing_complete _gxe_canvas_drawing_complete
#define gx_canvas_drawing_initiate(a, b, c)                                    \
  _gxe_canvas_drawing_initiate(a, (GX_WIDGET *)b, c)
...
#define gx_circular_gauge_background_draw _gx_circular_gauge_background_draw
#define gx_circular_gauge_create(a, b, c, d, e, f, g, h, i)                    \
  _gxe_circular_gauge_create((GX_CIRCULAR_GAUGE *)a, b, c, d, e, f, g, h, i,   \
                             sizeof(GX_CIRCULAR_GAUGE))
#define gx_circular_gauge_draw _gx_circular_gauge_draw
...
#define gx_display_create(a, b, c, d, e)                                       \
  _gxe_display_create(a, b, c, d, e, sizeof(GX_DISPLAY))
...
#define gx_drop_list_create(a, b, c, d, e, f, g, h, i)                         \
  _gxe_drop_list_create((GX_DROP_LIST *)a, b, (GX_WIDGET *)c, d, e, f, g, h,   \
                        i, sizeof(GX_DROP_LIST))
...
#define gx_generic_scroll_wheel_create(a, b, c, d, e, f, g, h)                 \
  _gxe_generic_scroll_wheel_create(a, b, c, d, e, f, g, h,                     \
                                   sizeof(GX_GENERIC_SCROLL_WHEEL))
...
#define gx_horizontal_list_create(a, b, c, d, e, f, g, h)                      \
  _gxe_horizontal_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,             \
                              sizeof(GX_HORIZONTAL_LIST))
#define gx_horizontal_list_event_process _gxe_horizontal_list_event_process
#define gx_horizontal_list_page_index_set(a, b)                                \
  _gxe_horizontal_list_page_index_set((GX_HORIZONTAL_LIST *)a, b)
#define gx_horizontal_list_selected_index_get(a, b)                            \
  _gxe_horizontal_list_selected_index_get(a, b)
#define gx_horizontal_list_selected_set(a, b)                                  \
  _gxe_horizontal_list_selected_set(a, b)
#define gx_horizontal_list_selected_widget_get(a, b)                           \
  _gxe_horizontal_list_selected_widget_get(a, (GX_WIDGET **)b)
#define gx_horizontal_list_total_columns_set(a, b)                             \
  _gxe_horizontal_list_total_columns_set((GX_HORIZONTAL_LIST *)a, b)

#define gx_horizontal_scrollbar_create(a, b, c, d, e)                          \
  _gxe_horizontal_scrollbar_create(a, b, (GX_WINDOW *)c, d, e,                 \
                                   sizeof(GX_SCROLLBAR))

#define gx_icon_background_draw _gx_icon_background_draw
#define gx_icon_button_create(a, b, c, d, e, f, g)                             \
  _gxe_icon_button_create(a, b, (GX_WIDGET *)c, d, e, f, g,                    \
                          sizeof(GX_ICON_BUTTON))
#define gx_icon_button_draw _gx_icon_button_draw
#define gx_icon_button_pixelmap_set _gxe_icon_button_pixelmap_set
#define gx_icon_create(a, b, c, d, e, f, g, h)                                 \
  _gxe_icon_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_ICON))
#define gx_icon_draw _gx_icon_draw
...
#define gx_line_chart_axis_draw _gx_line_chart_axis_draw
#define gx_line_chart_create(a, b, c, d, e, f, g)                              \
  _gxe_line_chart_create(a, b, (GX_WIDGET *)c, d, e, f, g,                     \
                         sizeof(GX_LINE_CHART))
#define gx_line_chart_data_draw _gx_line_chart_data_draw
#define gx_line_chart_draw _gx_line_chart_draw
...
#define gx_menu_create(a, b, c, d, e, f, g, h)                                 \
  _gxe_menu_create((GX_MENU *)a, b, (GX_WIDGET *)c, d, e, f, g, h,             \
                   sizeof(GX_MENU))
#define gx_menu_draw _gx_menu_draw
...
#define gx_multi_line_text_button_create(a, b, c, d, e, f, g)                  \
  _gxe_multi_line_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g,         \
                                     sizeof(GX_MULTI_LINE_TEXT_BUTTON))
#define gx_multi_line_text_button_draw _gx_multi_line_text_button_draw
#define gx_multi_line_text_button_event_process                                \
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_multi_line_text_input_char_insert                                   \
  _gxe_multi_line_text_input_char_insert
#endif
#define gx_multi_line_text_input_char_insert_ext                               \
  _gxe_multi_line_text_input_char_insert_ext
#define gx_multi_line_text_input_create(a, b, c, d, e, f, g, h)                \
  _gxe_multi_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,       \
                                    sizeof(GX_MULTI_LINE_TEXT_INPUT))
#define gx_multi_line_text_input_cursor_pos_get                                \
  _gxe_multi_line_text_input_cursor_pos_get
#define gx_multi_line_text_input_delete _gxe_multi_line_text_input_delete
#define gx_multi_line_text_input_down_arrow                                    \
...
#define gx_multi_line_text_input_left_arrow                                    \
  _gxe_multi_line_text_input_left_arrow
#define gx_multi_line_text_input_right_arrow                                   \
...
#define gx_multi_line_text_view_create(a, b, c, d, e, f, g)                    \
  _gxe_multi_line_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g,           \
                                   sizeof(GX_MULTI_LINE_TEXT_VIEW))
#define gx_multi_line_text_view_draw _gx_multi_line_text_view_draw
#define gx_multi_line_text_view_event_process                                  \
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_multi_line_text_view_text_color_set(a, b, c)                        \
  _gxe_multi_line_text_view_text_color_set((GX_MULTI_LINE_TEXT_VIEW *)a, b, c, \
                                           b)
#else
#define gx_multi_line_text_view_text_color_set                                 \
  _gxe_multi_line_text_view_text_color_set
#endif
#define gx_multi_line_text_view_text_id_set                                    \
...
#define gx_rich_text_view_create(a, b, c, d, e, f, g, h)                       \
  _gxe_rich_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,              \
                             sizeof(GX_RICH_TEXT_VIEW))
#define gx_rich_text_view_draw _gx_rich_text_view_draw
#define gx_rich_text_view_text_draw _gx_rich_text_view_text_draw
#define gx_rich_text_view_fonts_set _gxe_rich_text_view_fonts_set

#define gx_numeric_pixelmap_prompt_create(a, b, c, d, e, f, g, h)              \
  _gxe_numeric_pixelmap_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,     \
                                      sizeof(GX_NUMERIC_PIXELMAP_PROMPT))
#define gx_numeric_pixelmap_prompt_format_function_set                         \
...
#define gx_numeric_prompt_create(a, b, c, d, e, f, g)                          \
  _gxe_numeric_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g,                 \
                             sizeof(GX_NUMERIC_PROMPT))
#define gx_numeric_prompt_format_function_set                                  \
  _gxe_numeric_prompt_format_function_set
#define gx_numeric_prompt_value_set _gxe_numeric_prompt_value_set

#define gx_numeric_scroll_wheel_create(a, b, c, d, e, f, g, h)                 \
  _gxe_numeric_scroll_wheel_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,        \
                                   sizeof(GX_NUMERIC_SCROLL_WHEEL))
#define gx_numeric_scroll_wheel_range_set _gxe_numeric_scroll_wheel_range_set

#define gx_pixelmap_button_create(a, b, c, d, e, f, g, h, i)                   \
  _gxe_pixelmap_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, i,          \
                              sizeof(GX_PIXELMAP_BUTTON))
#define gx_pixelmap_button_draw _gx_pixelmap_button_draw
...
#define gx_pixelmap_prompt_create(a, b, c, d, e, f, g, h)                      \
  _gxe_pixelmap_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,             \
                              sizeof(GX_PIXELMAP_PROMPT))
#define gx_pixelmap_prompt_draw _gx_pixelmap_prompt_draw
#define gx_pixelmap_prompt_pixelmap_set _gxe_pixelmap_prompt_pixelmap_set

#define gx_pixelmap_slider_create(a, b, c, d, e, f, g, h)                      \
  _gxe_pixelmap_slider_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,             \
                              sizeof(GX_PIXELMAP_SLIDER))
#define gx_pixelmap_slider_draw _gx_pixelmap_slider_draw
...
#define gx_progress_bar_background_draw _gx_progress_bar_background_draw
#define gx_progress_bar_create(a, b, c, d, e, f, g)                            \
  _gxe_progress_bar_create(a, b, (GX_WIDGET *)c, d, e, f, g,                   \
                           sizeof(GX_PROGRESS_BAR))
#define gx_progress_bar_draw _gx_progress_bar_draw
...
#define gx_progress_bar_info_set(a, b)                                         \
  _gxe_progress_bar_info_set((GX_PROGRESS_BAR *)a, b);
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_progress_bar_text_color_set(a, b, c)                                \
  _gxe_progress_bar_text_color_set((GX_PROGRESS_BAR *)a, b, c, b)
#else
...
#define gx_prompt_create(a, b, c, d, e, f, g)                                  \
  _gxe_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_PROMPT))
#define gx_prompt_event_process _gxe_prompt_event_process
#define gx_prompt_draw _gx_prompt_draw
#define gx_prompt_font_set _gxe_prompt_font_set
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_prompt_text_color_set(a, b, c)                                      \
  _gxe_prompt_text_color_set((GX_PROMPT *)a, b, c, b)
#else
...
#define gx_radial_progress_bar_create(a, b, c, d, e, f)                        \
  _gxe_radial_progress_bar_create(a, b, c, d, e, f,                            \
                                  sizeof(GX_RADIAL_PROGRESS_BAR))
#define gx_radial_progress_bar_draw _gx_radial_progress_bar_draw
#define gx_radial_progress_bar_event_process                                   \
...
#else
#define gx_radial_progress_bar_text_color_set                                  \
  _gxe_radial_progress_bar_text_color_set
#endif
#define gx_radial_progress_bar_text_draw _gx_radial_progress_bar_text_draw
...
#define gx_radial_slider_create(a, b, c, d, e, f, g)                           \
  _gxe_radial_slider_create((GX_RADIAL_SLIDER *)a, b, c, d, e, f, g,           \
                            sizeof(GX_RADIAL_SLIDER))
#define gx_radial_slider_draw _gx_radial_slider_draw
...
#define gx_radio_button_create(a, b, c, d, e, f, g)                            \
  _gxe_radio_button_create(a, b, (GX_WIDGET *)c, d, e, f, g,                   \
                           sizeof(GX_RADIO_BUTTON))
#define gx_radio_button_draw _gx_radio_button_draw
...
#define gx_scroll_thumb_create(a, b, c)                                        \
  _gxe_scroll_thumb_create(a, b, c, sizeof(GX_SCROLL_THUMB))
#define gx_scroll_thumb_draw _gx_scroll_thumb_draw
...
#define gx_scroll_wheel_gradient_alpha_set(a, b, c)                            \
  _gxe_scroll_wheel_gradient_alpha_set((GX_SCROLL_WHEEL *)a, b, c)
#define gx_scroll_wheel_row_height_set(a, b)                                   \
  _gxe_scroll_wheel_row_height_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_background_set(a, b)                          \
  _gxe_scroll_wheel_selected_background_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_get(a, b)                                     \
  _gxe_scroll_wheel_selected_get((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_selected_set(a, b)                                     \
  _gxe_scroll_wheel_selected_set((GX_SCROLL_WHEEL *)a, b)
#define gx_scroll_wheel_speed_set(a, b, c, d, e)                               \
  _gxe_scroll_wheel_speed_set((GX_SCROLL_WHEEL *)a, b, c, d, e)
#define gx_scroll_wheel_total_rows_set(a, b)                                   \
  _gxe_scroll_wheel_total_rows_set((GX_SCROLL_WHEEL *)a, b)

#define gx_single_line_text_input_backspace(a)                                 \
  _gxe_single_line_text_input_backspace((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_buffer_clear(a)                              \
  _gxe_single_line_text_input_buffer_clear((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_buffer_get(a, b, c, d)                       \
  _gxe_single_line_text_input_buffer_get((GX_SINGLE_LINE_TEXT_INPUT *)a, b, c, \
                                         d)
#define gx_single_line_text_input_character_delete(a)                          \
  _gxe_single_line_text_input_character_delete(a)
#define gx_single_line_text_input_character_insert(a, b, c)                    \
  _gxe_single_line_text_input_character_insert(a, b, c)
#define gx_single_line_text_input_create(a, b, c, d, e, f, g, h)               \
  _gxe_single_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,      \
                                     sizeof(GX_SINGLE_LINE_TEXT_INPUT))
#define gx_single_line_text_input_draw(a) _gx_single_line_text_input_draw(a)
#define gx_single_line_text_input_draw_position_get(a, b, c)                   \
  _gxe_single_line_text_input_draw_position_get(a, b, c)
#define gx_single_line_text_input_end(a)                                       \
  _gxe_single_line_text_input_end((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_event_process(a, b)                          \
  _gxe_single_line_text_input_event_process((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_fill_color_set(a, b, c, d, e)                \
  _gxe_single_line_text_input_fill_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a,   \
                                             b, c, d, e)
#define gx_single_line_text_input_home(a)                                      \
  _gxe_single_line_text_input_home((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_left_arrow(a)                                \
  _gxe_single_line_text_input_left_arrow((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_position_get(a, b)                           \
  _gxe_single_line_text_input_position_get(a, b)
#define gx_single_line_text_input_right_arrow(a)                               \
  _gxe_single_line_text_input_right_arrow((GX_SINGLE_LINE_TEXT_INPUT *)a)
#define gx_single_line_text_input_style_add(a, b)                              \
...
#define gx_single_line_text_input_text_color_set(a, b, c, d, e)                \
  _gxe_single_line_text_input_text_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a,   \
                                             b, c, d, e)
#define gx_single_line_text_input_text_select                                  \
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_string_scroll_wheel_create(a, b, c, d, e, f, g, h)                  \
  _gxe_string_scroll_wheel_create(a, b, c, d, e, f, g, h,                      \
                                  sizeof(GX_STRING_SCROLL_WHEEL))
#define gx_string_scroll_wheel_string_list_set                                 \
  _gxe_string_scroll_wheel_string_list_set
#endif
#define gx_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h)              \
  _gxe_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h,                  \
                                      sizeof(GX_STRING_SCROLL_WHEEL))
#define gx_string_scroll_wheel_event_process                                   \
...
#define gx_system_dirty_partial_add(a, b)                                      \
  _gxe_system_dirty_partial_add((GX_WIDGET *)a, b)
...
#define gx_system_screen_stack_create(a, b)                                    \
  _gxe_system_screen_stack_create(a, b, sizeof(GX_SCREEN_STACK_CONTROL))
...
#define gx_text_button_create(a, b, c, d, e, f, g)                             \
  _gxe_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g,                    \
                          sizeof(GX_TEXT_BUTTON))
#define gx_text_button_draw _gx_text_button_draw
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_text_button_text_color_set(a, b, c)                                 \
  _gxe_text_button_text_color_set((GX_TEXT_BUTTON *)a, b, c, b)
#else
...
#define gx_text_input_cursor_height_set(a, b)                                  \
  _gxe_text_input_cursor_height_set((GX_TEXT_INPUT_CURSOR *)a, b)
#define gx_text_input_cursor_width_set(a, b)                                   \
  _gxe_text_input_cursor_width_set((GX_TEXT_INPUT_CURSOR *)a, b)

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_text_scroll_wheel_callback_set(a, b)                                \
  _gxe_text_scroll_wheel_callback_set(                                         \
      (GX_TEXT_SCROLL_WHEEL *)a,                                               \
      (GX_CONST GX_CHAR * (*)(GX_TEXT_SCROLL_WHEEL *, INT)) b)
#endif
#define gx_text_scroll_wheel_callback_set_ext(a, b)                            \
  _gxe_text_scroll_wheel_callback_set_ext(                                     \
      ...
      (UINT(*)(GX_TEXT_SCROLL_WHEEL *, INT, GX_STRING *))b)
#define gx_text_scroll_wheel_font_set(a, b, c)                                 \
  _gxe_text_scroll_wheel_font_set((GX_TEXT_SCROLL_WHEEL *)a, b, c)
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_text_scroll_wheel_text_color_set(a, b, c)                           \
...
#define gx_text_scroll_wheel_create(a, b, c, d, e, f, g)                       \
  _gxe_text_scroll_wheel_create(a, b, c, d, e, f, g,                           \
                                sizeof(GX_TEXT_SCROLL_WHEEL))
#define gx_text_scroll_wheel_draw _gx_text_scroll_wheel_draw
...
#define gx_tree_view_create(a, b, c, d, e, f)                                  \
  _gxe_tree_view_create((GX_TREE_VIEW *)a, b, (GX_WIDGET *)c, d, e, f,         \
                        sizeof(GX_TREE_VIEW))
#define gx_tree_view_draw _gx_tree_view_draw
...
#define gx_utility_rectangle_overlap_detect                                    \
...
#define gx_vertical_list_create(a, b, c, d, e, f, g, h)                        \
  _gxe_vertical_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h,               \
                            sizeof(GX_VERTICAL_LIST))
#define gx_vertical_list_event_process _gxe_vertical_list_event_process
#define gx_vertical_list_page_index_set(a, b)                                  \
  _gxe_vertical_list_page_index_set((GX_VERTICAL_LIST *)a, b)
#define gx_vertical_list_selected_index_get(a, b)                              \
  _gxe_vertical_list_selected_index_get(a, b)
#define gx_vertical_list_selected_set(a, b)                                    \
  _gxe_vertical_list_selected_set(a, b)
#define gx_vertical_list_selected_widget_get(a, b)                             \
  _gxe_vertical_list_selected_widget_get(a, (GX_WIDGET **)b)
#define gx_vertical_list_total_rows_set(a, b)                                  \
  _gxe_vertical_list_total_rows_set((GX_VERTICAL_LIST *)a, b)

#define gx_vertical_scrollbar_create(a, b, c, d, e)                            \
  _gxe_vertical_scrollbar_create(a, b, (GX_WINDOW *)c, d, e,                   \
                                 sizeof(GX_SCROLLBAR))

#define gx_widget_allocate(a, b) _gxe_widget_allocate((GX_WIDGET **)a, b)
#define gx_widget_attach(a, b)                                                 \
  _gxe_widget_attach((GX_WIDGET *)a, (GX_WIDGET *)b)
#define gx_widget_back_attach(a, b)                                            \
  _gxe_widget_back_attach((GX_WIDGET *)a, (GX_WIDGET *)b)
...
#define gx_widget_border_draw(a, b, c, d, e)                                   \
  _gx_widget_border_draw((GX_WIDGET *)a, b, c, d, e)
#define gx_widget_border_style_set(a, b)                                       \
  _gxe_widget_border_style_set((GX_WIDGET *)a, b)
#define gx_widget_border_width_get(a, b)                                       \
  _gxe_widget_border_width_get((GX_WIDGET *)a, b)
#define gx_widget_canvas_get(a, b) _gxe_widget_canvas_get((GX_WIDGET *)a, b)
#define gx_widget_child_detect(a, b, c)                                        \
  _gxe_widget_child_detect((GX_WIDGET *)a, b, c)
#define gx_widget_children_draw(a) _gx_widget_children_draw((GX_WIDGET *)a)
#define gx_widget_color_get(a, b, c) _gxe_widget_color_get((GX_WIDGET *)a, b, c)
#define gx_widget_client_get(a, b, c)                                          \
  _gxe_widget_client_get((GX_WIDGET *)a, b, c)
#define gx_widget_create(a, b, c, d, e, f)                                     \
  _gxe_widget_create((GX_WIDGET *)a, b, (GX_WIDGET *)c, d, e, f,               \
                     sizeof(GX_WIDGET))
...
#define gx_widget_draw(a) _gx_widget_draw((GX_WIDGET *)a)
#define gx_widget_draw_set(a, b)                                               \
  _gxe_widget_draw_set((GX_WIDGET *)a, (void (*)(GX_WIDGET *))b)
#define gx_widget_event_generate(a, b, c)                                      \
  _gxe_widget_event_generate((GX_WIDGET *)a, b, c)
#define gx_widget_event_process(a, b)                                          \
  _gxe_widget_event_process((GX_WIDGET *)a, b)
#define gx_widget_event_process_set(a, b)                                      \
  _gxe_widget_event_process_set((GX_WIDGET *)a,                                \
                                (UINT(*)(GX_WIDGET *, GX_EVENT *))b)
#define gx_widget_event_to_parent(a, b)                                        \
  _gxe_widget_event_to_parent((GX_WIDGET *)a, b)
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_widget_fill_color_set(a, b, c)                                      \
  _gxe_widget_fill_color_set((GX_WIDGET *)a, b, c, b)
#else
#define gx_widget_fill_color_set(a, b, c, d)                                   \
  _gxe_widget_fill_color_set((GX_WIDGET *)a, b, c, d)
#endif
#define gx_widget_find(a, b, c, d)                                             \
  _gxe_widget_find((GX_WIDGET *)a, b, c, (GX_WIDGET **)d)
#define gx_widget_first_child_get(a, b)                                        \
  _gxe_widget_first_child_get((GX_WIDGET *)a, (GX_WIDGET **)b)
...
#define gx_widget_last_child_get(a, b)                                         \
  _gxe_widget_last_child_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_next_sibling_get(a, b)                                       \
  _gxe_widget_next_sibling_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_parent_get(a, b)                                             \
  _gxe_widget_parent_get((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_pixelmap_get(a, b, c)                                        \
  _gxe_widget_pixelmap_get((GX_WIDGET *)a, b, c)
#define gx_widget_previous_sibling_get(a, b)                                   \
  _gxe_widget_previous_sibling_get((GX_WIDGET *)a, (GX_WIDGET **)b)
...
#define gx_widget_status_remove(a, b)                                          \
  _gxe_widget_status_remove((GX_WIDGET *)a, b)
#define gx_widget_status_test(a, b, c)                                         \
  _gxe_widget_status_test((GX_WIDGET *)a, b, c)
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_widget_string_get(a, b, c)                                          \
  _gxe_widget_string_get((GX_WIDGET *)a, b, c)
#endif
#define gx_widget_string_get_ext(a, b, c)                                      \
  _gxe_widget_string_get_ext((GX_WIDGET *)a, b, c)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_widget_text_blend(a, b, c, d, e, f, g)                              \
  _gxe_widget_text_blend((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_draw(a, b, c, d, e, f)                                  \
  _gx_widget_text_draw((GX_WIDGET *)a, b, c, d, e, f)
#endif
#define gx_widget_text_blend_ext(a, b, c, d, e, f, g)                          \
  _gxe_widget_text_blend_ext((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_draw_ext(a, b, c, d, e, f)                              \
  _gx_widget_text_draw_ext((GX_WIDGET *)a, b, c, d, e, f)
#define gx_widget_text_id_draw(a, b, c, d, e, f)                               \
  _gx_widget_text_id_draw((GX_WIDGET *)a, b, c, d, e, f)
#define gx_widget_top_visible_child_find(a, b)                                 \
  _gxe_widget_top_visible_child_find((GX_WIDGET *)a, (GX_WIDGET **)b)
#define gx_widget_type_find(a, b, c)                                           \
  _gxe_widget_type_find((GX_WIDGET *)a, b, (GX_WIDGET **)c)
...
#define gx_window_create(a, b, c, d, e, f)                                     \
  _gxe_window_create(a, b, (GX_WIDGET *)c, d, e, f, sizeof(GX_WINDOW))
#define gx_window_draw _gx_window_draw
#define gx_window_event_process _gxe_window_event_process
#define gx_window_execute _gxe_window_execute
#define gx_window_root_create(a, b, c, d, e, f)                                \
  _gxe_window_root_create(a, b, c, d, e, f, sizeof(GX_WINDOW_ROOT))
...
#define gx_window_wallpaper_set(a, b, c)                                       \
  _gxe_window_wallpaper_set((GX_WINDOW *)a, b, c)

/* Define the error checking function prototypes of the GUIX API.  */
UINT _gxe_accordion_menu_create(GX_ACCORDION_MENU *accordion,
                                GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                ULONG style, USHORT accordion_menu_id,
                                GX_CONST GX_RECTANGLE *size,
                                UINT control_block_size);
VOID _gx_accordion_menu_draw(GX_ACCORDION_MENU *menu);
UINT _gxe_accordion_menu_event_process(GX_ACCORDION_MENU *accordion,
                                       GX_EVENT *event_ptr);
...
UINT _gxe_animation_drag_enable(GX_ANIMATION *animation, GX_WIDGET *widget,
                                GX_ANIMATION_INFO *info);
UINT _gxe_animation_landing_speed_set(GX_ANIMATION *animation,
                                      USHORT shift_per_step);
UINT _gxe_animation_start(GX_ANIMATION *animation, GX_ANIMATION_INFO *info);
UINT _gxe_animation_stop(GX_ANIMATION *animation);

UINT _gxe_binres_language_count_get(GX_UBYTE *root_address,
                                    GX_VALUE *put_count);
UINT _gxe_binres_language_info_load(GX_UBYTE *root_address,
                                    GX_LANGUAGE_HEADER *put_info);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_binres_language_table_load(GX_UBYTE *root_address,
                                     GX_UBYTE ****returned_language_table);
#endif
UINT _gxe_binres_language_table_load_ext(GX_UBYTE *root_address,
                                         GX_STRING ***returned_language_table);
UINT _gxe_binres_theme_load(GX_UBYTE *root_address, INT theme_id,
                            GX_THEME **returned_theme);
UINT _gxe_binres_pixelmap_load(GX_UBYTE *root_address, UINT map_index,
                               GX_PIXELMAP *pixelmap);
UINT _gxe_binres_font_load(GX_UBYTE *root_address, UINT font_index,
                           GX_UBYTE *buffer, ULONG *buffer_size);

UINT _gxe_brush_default(GX_BRUSH *brush);
UINT _gxe_brush_define(GX_BRUSH *brush, GX_COLOR line_color,
                       GX_COLOR fill_color, UINT style);

VOID _gx_button_background_draw(GX_BUTTON *button);
UINT _gxe_button_create(GX_BUTTON *button, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, ULONG style, USHORT Id,
                        GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_canvas_arc_draw(INT xcenter, INT ycenter, UINT r, INT start_angle,
                          INT end_angle);
UINT _gxe_canvas_block_move(GX_RECTANGLE *block, GX_VALUE x_shift,
                            GX_VALUE y_shift, GX_RECTANGLE *dirty);
...
UINT _gxe_canvas_drawing_initiate(GX_CANVAS *canvas, GX_WIDGET *who,
                                  GX_RECTANGLE *dirty_area);
...
UINT _gxe_canvas_line_draw(GX_VALUE x_start, GX_VALUE y_start, GX_VALUE x_end,
                           GX_VALUE y_end);
UINT _gxe_canvas_memory_define(GX_CANVAS *canvas, GX_COLOR *memory,
                               ULONG memsize);
...
UINT _gxe_canvas_pie_draw(INT xcenter, INT ycenter, UINT r, INT start_angle,
                          INT end_angle);
UINT _gxe_canvas_pixel_draw(GX_POINT position);
UINT _gxe_canvas_pixelmap_blend(GX_VALUE x_position, GX_VALUE y_position,
                                GX_PIXELMAP *pixelmap, GX_UBYTE alpha);
UINT _gxe_canvas_pixelmap_draw(GX_VALUE x_position, GX_VALUE y_position,
                               GX_PIXELMAP *pixelmap);
UINT _gxe_canvas_pixelmap_get(GX_PIXELMAP *pixelmap);
UINT _gxe_canvas_pixelmap_rotate(GX_VALUE x_position, GX_VALUE y_position,
                                 GX_PIXELMAP *pixelmap, INT angle, INT rot_cx,
                                 INT rot_cy);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_canvas_rotated_text_draw(GX_CONST GX_CHAR *text, GX_VALUE xcenter,
                                   GX_VALUE ycenter, INT angle);
#endif
UINT _gxe_canvas_rotated_text_draw_ext(GX_CONST GX_STRING *text,
                                       GX_VALUE xcenter, GX_VALUE ycenter,
                                       INT angle);
UINT _gxe_canvas_shift(GX_CANVAS *canvas, GX_VALUE x, GX_VALUE y);
UINT _gxe_canvas_show(GX_CANVAS *canvas);

UINT _gxe_canvas_aligned_text_draw(GX_CONST GX_STRING *string,
                                   GX_RECTANGLE *rectangle, ULONG alignment);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_canvas_text_draw(GX_VALUE x_start, GX_VALUE y_start,
                           GX_CONST GX_CHAR *string, INT length);
#endif
UINT _gxe_canvas_text_draw_ext(GX_VALUE x_start, GX_VALUE y_start,
                               GX_CONST GX_STRING *string);
...
UINT _gxe_checkbox_pixelmap_set(GX_CHECKBOX *button,
...
UINT _gxe_circular_gauge_angle_get(GX_CIRCULAR_GAUGE *circular_gauge,
                                   INT *angle);
UINT _gxe_circular_gauge_angle_set(GX_CIRCULAR_GAUGE *circular_gauge,
                                   INT angle);
UINT _gxe_circular_gauge_animation_set(GX_CIRCULAR_GAUGE *circular_gauge,
                                       INT animation_steps, INT delay);
VOID _gx_circular_gauge_background_draw(GX_CIRCULAR_GAUGE *gauge);
UINT _gxe_circular_gauge_create(GX_CIRCULAR_GAUGE *circular_gauge,
                                ...
                                UINT checkbox_control_block_size);
VOID _gx_circular_gauge_draw(GX_CIRCULAR_GAUGE *circular_gauge);
UINT _gxe_circular_gauge_event_process(GX_CIRCULAR_GAUGE *circular_gauge,
                                       GX_EVENT *event_ptr);

UINT _gxe_context_brush_default(GX_DRAW_CONTEXT *context);
UINT _gxe_context_brush_define(GX_RESOURCE_ID line_color_id,
                               GX_RESOURCE_ID fill_color_id, UINT style);
...
UINT _gxe_context_pixelmap_get(GX_RESOURCE_ID resource_id,
                               GX_PIXELMAP **return_pixelmap);
UINT _gxe_context_pixelmap_set(GX_RESOURCE_ID pixelmap_id);
UINT _gxe_context_raw_brush_define(GX_COLOR line_color, GX_COLOR fill_color,
                                   UINT style);
UINT _gxe_context_raw_fill_color_set(GX_COLOR line_color);
UINT _gxe_context_raw_line_color_set(GX_COLOR line_color);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_context_string_get(GX_RESOURCE_ID string_id,
                             GX_CONST GX_CHAR **return_string);
#endif
UINT _gxe_context_string_get_ext(GX_RESOURCE_ID string_id,
                                 GX_STRING *return_string);

UINT _gxe_display_active_language_set(GX_DISPLAY *display, GX_UBYTE language);
UINT _gxe_display_color_set(GX_DISPLAY *display, GX_RESOURCE_ID resource_id,
                            GX_COLOR new_color);
UINT _gxe_display_color_table_set(GX_DISPLAY *display, GX_COLOR *color_table,
                                  INT number_of_colors);
UINT _gxe_display_create(GX_DISPLAY *display, GX_CONST GX_CHAR *name,
                         UINT (*display_driver_setup)(GX_DISPLAY *),
                         GX_VALUE width, GX_VALUE height,
                         UINT display_control_block_size);
UINT _gxe_display_delete(GX_DISPLAY *display,
                         VOID (*display_driver_cleanup)(GX_DISPLAY *));
UINT _gxe_display_font_table_set(GX_DISPLAY *display, GX_FONT **font_table,
                                 UINT number_of_fonts);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_display_language_table_get(GX_DISPLAY *display, GX_CHAR ****table,
                                     GX_UBYTE *language_count,
                                     UINT *string_count);
UINT _gxe_display_language_table_set(GX_DISPLAY *display, GX_CHAR ***table,
                                     GX_UBYTE num_languages,
                                     UINT number_of_strings);
#endif
UINT _gxe_display_language_table_get_ext(GX_DISPLAY *display,
                                         GX_STRING ***table,
                                         GX_UBYTE *language_count,
                                         UINT *string_count);
UINT _gxe_display_language_table_set_ext(GX_DISPLAY *display,
                                         GX_CONST GX_STRING **table,
                                         GX_UBYTE num_languages,
                                         UINT number_of_strings);
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
UINT _gxe_display_language_direction_table_set(
    GX_DISPLAY *display, GX_CONST GX_UBYTE *language_direction_table,
    GX_UBYTE num_languages);
#endif
UINT _gxe_display_pixelmap_table_set(GX_DISPLAY *display,
                                     GX_PIXELMAP **pixelmap_table,
                                     UINT number_of_pixelmaps);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_display_string_get(GX_DISPLAY *display, GX_RESOURCE_ID string_id,
                             GX_CONST GX_CHAR **return_string);
UINT _gxe_display_string_table_get(GX_DISPLAY *display, GX_UBYTE language,
                                   GX_CHAR ***table, UINT *size);
#endif
UINT _gxe_display_string_get_ext(GX_DISPLAY *display, GX_RESOURCE_ID string_id,
                                 GX_STRING *return_string);
UINT _gxe_display_string_table_get_ext(GX_DISPLAY *display, GX_UBYTE language,
                                       GX_STRING **table, UINT *size);
UINT _gxe_display_theme_install(GX_DISPLAY *display,
                                GX_CONST GX_THEME *theme_ptr);
...
UINT _gxe_drop_list_create(GX_DROP_LIST *drop_list, GX_CONST GX_CHAR *name,
                           ...
                           ULONG style, USHORT drop_list_id,
                           GX_CONST GX_RECTANGLE *size,
                           UINT drop_list_control_block_size);
UINT _gxe_drop_list_event_process(GX_DROP_LIST *list, GX_EVENT *event_ptr);
UINT _gxe_drop_list_open(GX_DROP_LIST *list);
UINT _gxe_drop_list_pixelmap_set(GX_DROP_LIST *drop_list,
                                 GX_RESOURCE_ID pixelmap_id);
UINT _gxe_drop_list_popup_get(GX_DROP_LIST *box,
                              GX_VERTICAL_LIST **return_list);

UINT _gxe_generic_scroll_wheel_create(
    GX_GENERIC_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT total_rows,
    VOID (*callback)(GX_GENERIC_SCROLL_WHEEL *, GX_WIDGET *, INT), ULONG style,
    USHORT id, GX_CONST GX_RECTANGLE *size, UINT control_block_size);
UINT _gxe_generic_scroll_wheel_children_position(
    GX_GENERIC_SCROLL_WHEEL *wheel);
UINT _gxe_generic_scroll_wheel_event_process(GX_GENERIC_SCROLL_WHEEL *wheel,
                                             GX_EVENT *event_ptr);
UINT _gxe_generic_scroll_wheel_row_height_set(GX_GENERIC_SCROLL_WHEEL *wheel,
                                              GX_VALUE row_height);
UINT _gxe_generic_scroll_wheel_total_rows_set(GX_GENERIC_SCROLL_WHEEL *wheel,
                                              INT count);

UINT _gxe_horizontal_list_children_position(
    GX_HORIZONTAL_LIST *horizontal_list);
UINT _gxe_horizontal_list_create(
    GX_HORIZONTAL_LIST *horizontal_list, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, INT total_columns,
    VOID (*callback)(GX_HORIZONTAL_LIST *, GX_WIDGET *, INT), ULONG style,
    USHORT horizontal_list_id, GX_CONST GX_RECTANGLE *size,
    UINT horizontal_list_control_block_size);
UINT _gxe_horizontal_list_event_process(GX_HORIZONTAL_LIST *list,
                                        GX_EVENT *event_ptr);
UINT _gxe_horizontal_list_page_index_set(GX_HORIZONTAL_LIST *horizontal_list,
                                         INT list_entry);
UINT _gxe_horizontal_list_selected_index_get(
    GX_HORIZONTAL_LIST *horizontal_list, INT *return_index);
UINT _gxe_horizontal_list_selected_set(GX_HORIZONTAL_LIST *horizontal_list,
                                       INT index);
UINT _gxe_horizontal_list_selected_widget_get(
    GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET **return_list_entry);
UINT _gxe_horizontal_list_total_columns_set(GX_HORIZONTAL_LIST *horizontal_list,
                                            INT count);

UINT _gxe_horizontal_scrollbar_create(GX_SCROLLBAR *scrollbar,
                                      GX_CONST GX_CHAR *name, GX_WINDOW *parent,
                                      GX_SCROLLBAR_APPEARANCE *appearance,
                                      ULONG style,
...
VOID _gx_icon_background_draw(GX_ICON *icon);
UINT _gxe_icon_button_create(GX_ICON_BUTTON *button, GX_CONST GX_CHAR *name,
                             GX_WIDGET *parent, GX_RESOURCE_ID icon_id,
                             ULONG style, USHORT icon_button_id,
                             GX_CONST GX_RECTANGLE *size,
                             UINT button_control_block_size);
...
UINT _gxe_icon_pixelmap_set(GX_ICON *icon, GX_RESOURCE_ID normal_id,
                            GX_RESOURCE_ID selected_id);

UINT _gxe_image_reader_create(GX_IMAGE_READER *image_reader,
                              GX_CONST GX_UBYTE *read_data, INT read_data_size,
                              GX_UBYTE color_format, GX_UBYTE mode);
UINT _gxe_image_reader_palette_set(GX_IMAGE_READER *image_reader, GX_COLOR *pal,
                                   UINT palsize);
UINT _gxe_image_reader_start(GX_IMAGE_READER *image_reader,
                             GX_PIXELMAP *outmap);

VOID _gx_line_chart_axis_draw(GX_LINE_CHART *chart);
UINT _gxe_line_chart_create(GX_LINE_CHART *chart, GX_CONST GX_CHAR *name,
                            GX_WIDGET *parent,
                            GX_CONST GX_LINE_CHART_INFO *info, ULONG style,
                            USHORT chart_id, GX_CONST GX_RECTANGLE *size,
...
VOID _gx_menu_text_draw(GX_MENU *menu);
UINT _gxe_menu_text_offset_set(GX_MENU *menu, GX_VALUE x_offset,
                               GX_VALUE y_offset);

UINT _gxe_multi_line_text_button_create(GX_MULTI_LINE_TEXT_BUTTON *button,
                                        GX_CONST GX_CHAR *name,
                                        GX_WIDGET *parent,
                                        GX_RESOURCE_ID text_id, ULONG style,
                                        USHORT Id, GX_CONST GX_RECTANGLE *size,
                                        UINT control_block_size);
VOID _gx_multi_line_text_button_draw(GX_MULTI_LINE_TEXT_BUTTON *button);
UINT _gxe_multi_line_text_button_event_process(
    GX_MULTI_LINE_TEXT_BUTTON *button, GX_EVENT *event_ptr);
VOID _gx_multi_line_text_button_text_draw(GX_MULTI_LINE_TEXT_BUTTON *button);
...
UINT _gxe_multi_line_text_button_text_set(GX_MULTI_LINE_TEXT_BUTTON *button,
                                          GX_CONST GX_CHAR *text);
#endif
UINT _gxe_multi_line_text_button_text_set_ext(GX_MULTI_LINE_TEXT_BUTTON *button,
                                              GX_CONST GX_STRING *text);
...
UINT _gxe_multi_line_text_input_buffer_get(
    ...
    UINT *content_size, UINT *buffer_size);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_multi_line_text_input_char_insert(
    GX_MULTI_LINE_TEXT_INPUT *text_input, GX_UBYTE *str, UINT str_size);
#endif
UINT _gxe_multi_line_text_input_char_insert_ext(
    GX_MULTI_LINE_TEXT_INPUT *text_input, GX_CONST GX_STRING *str);
...
UINT _gxe_multi_line_text_input_cursor_pos_get(GX_MULTI_LINE_TEXT_INPUT *input,
                                               GX_POINT *cursor_pos);
UINT _gxe_multi_line_text_input_delete(GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gxe_multi_line_text_input_down_arrow(
    GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gxe_multi_line_text_input_end(GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gxe_multi_line_text_input_event_process(GX_MULTI_LINE_TEXT_INPUT *input,
                                              GX_EVENT *event_ptr);
UINT _gxe_multi_line_text_input_style_add(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gxe_multi_line_text_input_style_remove(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gxe_multi_line_text_input_style_set(
    GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gxe_multi_line_text_input_fill_color_set(
...
UINT _gxe_multi_line_text_input_left_arrow(
    GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gxe_multi_line_text_input_right_arrow(
    GX_MULTI_LINE_TEXT_INPUT *text_input);
UINT _gxe_multi_line_text_input_text_color_set(
    GX_MULTI_LINE_TEXT_INPUT *view, GX_RESOURCE_ID normal_color_id,
    GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
    GX_RESOURCE_ID readonly_color_id);
UINT _gxe_multi_line_text_input_text_select(GX_MULTI_LINE_TEXT_INPUT *input,
                                            UINT start_index, UINT end_index);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_multi_line_text_input_text_set(GX_MULTI_LINE_TEXT_INPUT *text_input,
                                         GX_CONST GX_CHAR *text);
#endif
UINT _gxe_multi_line_text_input_text_set_ext(
    GX_MULTI_LINE_TEXT_INPUT *text_input, GX_CONST GX_STRING *text);
...
VOID _gx_multi_line_text_view_draw(GX_MULTI_LINE_TEXT_VIEW *view);
UINT _gxe_multi_line_text_view_event_process(GX_MULTI_LINE_TEXT_VIEW *view,
                                             GX_EVENT *event_ptr);
UINT _gxe_multi_line_text_view_font_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                        GX_RESOURCE_ID font_id);
UINT _gxe_multi_line_text_view_line_space_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                              GX_BYTE line_space);
UINT _gxe_multi_line_text_view_scroll_info_get(
    GX_MULTI_LINE_TEXT_VIEW *view, ULONG style,
    GX_SCROLL_INFO *return_scroll_info);
...
UINT _gxe_multi_line_text_view_text_id_set(
    GX_MULTI_LINE_TEXT_VIEW *text_view_ptr, GX_RESOURCE_ID text_id);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
...
UINT _gxe_multi_line_text_view_text_set_ext(GX_MULTI_LINE_TEXT_VIEW *view,
                                            GX_CONST GX_STRING *text);
UINT _gxe_multi_line_text_view_whitespace_set(GX_MULTI_LINE_TEXT_VIEW *view,
                                              GX_UBYTE whitespace);
...
VOID _gx_rich_text_view_draw(GX_RICH_TEXT_VIEW *text_view);
VOID _gx_rich_text_view_text_draw(GX_RICH_TEXT_VIEW *text_view);
UINT _gxe_rich_text_view_fonts_set(GX_RICH_TEXT_VIEW *rich_view,
                                   GX_RICH_TEXT_FONTS *fonts);

UINT _gxe_numeric_pixelmap_prompt_create(
    GX_NUMERIC_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, GX_RESOURCE_ID text_id, GX_RESOURCE_ID fill_id,
    ULONG style, USHORT pixelmap_prompt_id, GX_CONST GX_RECTANGLE *size,
    UINT control_block_size);
UINT _gxe_numeric_pixelmap_prompt_format_function_set(
    GX_NUMERIC_PIXELMAP_PROMPT *prompt,
    VOID (*format_func)(GX_NUMERIC_PIXELMAP_PROMPT *, INT));
UINT _gxe_numeric_pixelmap_prompt_value_set(GX_NUMERIC_PIXELMAP_PROMPT *prompt,
                                            INT value);

UINT _gxe_numeric_prompt_create(GX_NUMERIC_PROMPT *prompt,
                                GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                GX_RESOURCE_ID text_id, ULONG style,
                                USHORT prompt_id, GX_CONST GX_RECTANGLE *size,
                                UINT control_block_size);
UINT _gxe_numeric_prompt_format_function_set(
    GX_NUMERIC_PROMPT *prompt, VOID (*format_func)(GX_NUMERIC_PROMPT *, INT));
...
UINT _gxe_numeric_scroll_wheel_range_set(GX_NUMERIC_SCROLL_WHEEL *wheel,
                                         INT start_val, INT end_val);

UINT _gxe_pixelmap_button_create(
    GX_PIXELMAP_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
...
VOID _gx_pixelmap_button_draw(GX_PIXELMAP_BUTTON *button);
UINT _gxe_pixelmap_button_event_process(GX_PIXELMAP_BUTTON *button,
                                        GX_EVENT *event_ptr);
...
UINT _gxe_pixelmap_prompt_create(GX_PIXELMAP_PROMPT *prompt,
                                 GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                 GX_RESOURCE_ID text_id,
                                 GX_RESOURCE_ID normal_pixelmap_id, ULONG style,
                                 USHORT prompt_id, GX_CONST GX_RECTANGLE *size,
...
VOID _gx_pixelmap_slider_draw(GX_PIXELMAP_SLIDER *slider);
UINT _gxe_pixelmap_slider_event_process(GX_PIXELMAP_SLIDER *slider,
                                        GX_EVENT *event_prt);
UINT _gxe_pixelmap_slider_pixelmap_set(GX_PIXELMAP_SLIDER *slider,
                                       GX_PIXELMAP_SLIDER_INFO *info);

VOID _gx_progress_bar_background_draw(GX_PROGRESS_BAR *progress_bar);
UINT _gxe_progress_bar_create(GX_PROGRESS_BAR *progress_bar,
                              GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                              GX_PROGRESS_BAR_INFO *progress_bar_info,
                              ULONG style, USHORT progress_bar_id,
                              GX_CONST GX_RECTANGLE *size,
...
VOID _gx_progress_bar_draw(GX_PROGRESS_BAR *progress_bar);
UINT _gxe_progress_bar_event_process(GX_PROGRESS_BAR *progress_bar,
                                     GX_EVENT *event_ptr);
UINT _gxe_progress_bar_font_set(GX_PROGRESS_BAR *progress_bar,
                                GX_RESOURCE_ID font_id);
UINT _gxe_progress_bar_info_set(GX_PROGRESS_BAR *progress_bar,
                                GX_PROGRESS_BAR_INFO *info);
UINT _gxe_progress_bar_pixelmap_set(GX_PROGRESS_BAR *progress_bar,
                                    GX_RESOURCE_ID pixelmap);
UINT _gxe_progress_bar_range_set(GX_PROGRESS_BAR *progress_bar, INT min_value,
                                 INT max_value);
...
UINT _gxe_prompt_create(GX_PROMPT *prompt, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, GX_RESOURCE_ID text_id, ULONG style,
                        USHORT prompt_id, GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_radial_progress_bar_anchor_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                         GX_VALUE angle);
VOID _gx_radial_progress_bar_background_draw(
    GX_RADIAL_PROGRESS_BAR *progress_bar);
UINT _gxe_radial_progress_bar_create(
    GX_RADIAL_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, GX_RADIAL_PROGRESS_BAR_INFO *progress_bar_info,
    ULONG style, USHORT progress_bar_id, UINT progress_bar_control_block_size);
VOID _gx_radial_progress_bar_draw(GX_RADIAL_PROGRESS_BAR *progress_bar);
UINT _gxe_radial_progress_bar_event_process(
    GX_RADIAL_PROGRESS_BAR *progress_bar, GX_EVENT *event_ptr);
UINT _gxe_radial_progress_bar_font_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                       GX_RESOURCE_ID font_id);
UINT _gxe_radial_progress_bar_info_set(GX_RADIAL_PROGRESS_BAR *bar,
                                       GX_RADIAL_PROGRESS_BAR_INFO *info);
UINT _gxe_radial_progress_bar_text_color_set(
    GX_RADIAL_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID normal_text_color_id,
    GX_RESOURCE_ID selected_text_color_id,
    GX_RESOURCE_ID disabled_text_color_id);
VOID _gx_radial_progress_bar_text_draw(GX_RADIAL_PROGRESS_BAR *bar);
UINT _gxe_radial_progress_bar_value_set(GX_RADIAL_PROGRESS_BAR *progress_bar,
                                        GX_VALUE new_value);

UINT _gxe_radial_slider_anchor_angles_set(GX_RADIAL_SLIDER *slider,
                                          GX_VALUE *anchor_angles,
                                          USHORT anchor_count);
UINT _gxe_radial_slider_animation_set(
    GX_RADIAL_SLIDER *slider, USHORT steps, USHORT delay,
    USHORT animation_style,
    VOID (*animation_update_callback)(GX_RADIAL_SLIDER *slider));
UINT _gxe_radial_slider_animation_start(GX_RADIAL_SLIDER *slider,
                                        GX_VALUE new_value);
UINT _gxe_radial_slider_create(GX_RADIAL_SLIDER *slider, GX_CONST GX_CHAR *name,
                               GX_WIDGET *parent, GX_RADIAL_SLIDER_INFO *info,
                               ULONG style, USHORT slider_id,
                               GX_CONST GX_RECTANGLE *size,
                               UINT control_block_size);
VOID _gx_radial_slider_draw(GX_RADIAL_SLIDER *slider);
UINT _gxe_radial_slider_event_process(GX_RADIAL_SLIDER *slider,
                                      GX_EVENT *event_ptr);
UINT _gxe_radial_slider_info_get(GX_RADIAL_SLIDER *slider,
                                 GX_RADIAL_SLIDER_INFO **info);
UINT _gxe_radial_slider_info_set(GX_RADIAL_SLIDER *slider,
                                 GX_RADIAL_SLIDER_INFO *info);
UINT _gxe_radial_slider_pixelmap_set(GX_RADIAL_SLIDER *slider,
                                     GX_RESOURCE_ID background_pixelmap,
                                     GX_RESOURCE_ID needle_pixelmap);
UINT _gxe_radial_slider_angle_set(GX_RADIAL_SLIDER *slider, GX_VALUE new_angle);

UINT _gxe_radio_button_create(GX_RADIO_BUTTON *button, GX_CONST GX_CHAR *name,
                              GX_WIDGET *parent, GX_RESOURCE_ID text_id,
                              ULONG style, USHORT radio_button_id,
                              GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_screen_stack_create(GX_SCREEN_STACK_CONTROL *control,
                              GX_WIDGET **memory, INT size);
UINT _gxe_screen_stack_pop(GX_SCREEN_STACK_CONTROL *control);
UINT _gxe_screen_stack_push(GX_SCREEN_STACK_CONTROL *control, GX_WIDGET *screen,
                            GX_WIDGET *new_screen);
UINT _gxe_screen_stack_reset(GX_SCREEN_STACK_CONTROL *control);

UINT _gxe_scroll_thumb_create(GX_SCROLL_THUMB *scroll_thumb,
                              GX_SCROLLBAR *parent, ULONG style,
                              UINT scroll_thumb_control_block_size);
VOID _gx_scroll_thumb_draw(GX_SCROLL_THUMB *scroll_thumb);
UINT _gxe_scroll_thumb_event_process(GX_SCROLL_THUMB *scroll_thumb,
                                     GX_EVENT *event_ptr);
...
UINT _gxe_scroll_wheel_create(GX_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name,
                              GX_WIDGET *parent, INT total_rows, ULONG style,
                              USHORT Id, GX_CONST GX_RECTANGLE *size,
                              UINT control_block_size);
UINT _gxe_scroll_wheel_event_process(GX_SCROLL_WHEEL *wheel,
                                     GX_EVENT *event_ptr);
UINT _gxe_scroll_wheel_gradient_alpha_set(GX_SCROLL_WHEEL *wheel,
                                          GX_UBYTE start_alpha,
                                          GX_UBYTE end_alpha);
UINT _gxe_scroll_wheel_row_height_set(GX_SCROLL_WHEEL *wheel,
                                      GX_VALUE row_height);
UINT _gxe_scroll_wheel_selected_background_set(GX_SCROLL_WHEEL *wheel,
                                               GX_RESOURCE_ID selected_bg);
...
UINT _gxe_scroll_wheel_speed_set(GX_SCROLL_WHEEL *wheel,
                                 GX_FIXED_VAL start_speed_rate,
...
UINT _gxe_single_line_text_input_backspace(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_buffer_clear(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_buffer_get(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CHAR **buffer_address,
    UINT *content_size, UINT *buffer_size);
UINT _gxe_single_line_text_input_character_delete(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_character_insert(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_UBYTE *str, UINT str_size);
UINT _gxe_single_line_text_input_create(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name,
    GX_WIDGET *parent, GX_CHAR *input_buffer, UINT buffer_size, UINT style,
    USHORT text_input_id, GX_CONST GX_RECTANGLE *size,
    UINT text_input_control_block_size);
VOID _gx_single_line_text_input_draw(GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_draw_position_get(
    GX_SINGLE_LINE_TEXT_INPUT *input, GX_VALUE *xpos, GX_VALUE *ypos);
UINT _gxe_single_line_text_input_end(GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_event_process(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_EVENT *event_ptr);
UINT _gxe_single_line_text_input_home(GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_left_arrow(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_position_get(
    GX_SINGLE_LINE_TEXT_INPUT *text_input, INT pixel_position);
UINT _gxe_single_line_text_input_right_arrow(
    GX_SINGLE_LINE_TEXT_INPUT *text_input);
UINT _gxe_single_line_text_input_style_add(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gxe_single_line_text_input_style_remove(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gxe_single_line_text_input_style_set(
    GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG style);
UINT _gxe_single_line_text_input_fill_color_set(
...
UINT _gxe_single_line_text_input_text_color_set(
    ...
    GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
    GX_RESOURCE_ID readonly_color_id);
UINT _gxe_single_line_text_input_text_select(GX_SINGLE_LINE_TEXT_INPUT *input,
                                             UINT start_index, UINT end_index);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_single_line_text_input_text_set(GX_SINGLE_LINE_TEXT_INPUT *input,
                                          GX_CONST GX_CHAR *text);
#endif
UINT _gxe_single_line_text_input_text_set_ext(GX_SINGLE_LINE_TEXT_INPUT *input,
                                              GX_CONST GX_STRING *text);

UINT _gxe_slider_create(GX_SLIDER *slider, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, INT tick_count,
                        GX_SLIDER_INFO *slider_info, ULONG style,
                        USHORT slider_id, GX_CONST GX_RECTANGLE *size,
...
VOID _gx_slider_needle_draw(GX_SLIDER *slider);
UINT _gxe_slider_needle_position_get(GX_SLIDER *slider,
                                     GX_SLIDER_INFO *slider_info,
                                     GX_RECTANGLE *return_position);
VOID _gx_slider_tickmarks_draw(GX_SLIDER *slider);
UINT _gxe_slider_travel_get(GX_SLIDER *widget, GX_SLIDER_INFO *info,
                            INT *mintravel, INT *maxtravel);
UINT _gxe_slider_value_calculate(GX_SLIDER *slider, GX_SLIDER_INFO *info,
                                 INT new_position);
UINT _gxe_slider_value_set(GX_SLIDER *slider, GX_SLIDER_INFO *info,
                           INT new_value);

UINT _gxe_sprite_create(GX_SPRITE *sprite, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, GX_SPRITE_FRAME *frame_list,
                        USHORT framecount, ULONG style, USHORT sprite_id,
                        GX_CONST GX_RECTANGLE *size,
                        UINT sprite_control_block_size);
UINT _gxe_sprite_current_frame_set(GX_SPRITE *sprite, USHORT frame);
UINT _gxe_sprite_frame_list_set(GX_SPRITE *sprite, GX_SPRITE_FRAME *frame_list,
                                USHORT frame_count);
UINT _gxe_sprite_start(GX_SPRITE *sprite, USHORT start_frame);
UINT _gxe_sprite_stop(GX_SPRITE *sprite);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_string_scroll_wheel_create(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT value_count, GX_CONST GX_CHAR **string_list, ULONG style, USHORT Id,
    GX_CONST GX_RECTANGLE *size, UINT control_block_size);
#endif
UINT _gxe_string_scroll_wheel_create_ext(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT total_rows, GX_CONST GX_STRING *string_list, ULONG style, USHORT Id,
    GX_CONST GX_RECTANGLE *size, UINT control_block_size);
UINT _gxe_string_scroll_wheel_event_process(GX_STRING_SCROLL_WHEEL *wheel,
                                            GX_EVENT *event_ptr);
UINT _gxe_string_scroll_wheel_string_id_list_set(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_RESOURCE_ID *string_id_list,
    INT id_count);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_string_scroll_wheel_string_list_set(GX_STRING_SCROLL_WHEEL *wheel,
                                              ...
                                              INT string_count);
#endif
UINT _gxe_string_scroll_wheel_string_list_set_ext(
    GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_STRING *string_list,
    INT string_count);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_system_language_table_get(GX_CHAR ****language_table,
                                    GX_UBYTE *language_count,
                                    UINT *string_count);
UINT _gxe_system_language_table_set(GX_CHAR ***language_table,
                                    GX_UBYTE number_of_languages,
                                    UINT number_of_strings);
#endif
UINT _gxe_system_memory_allocator_set(VOID *(*allocate)(ULONG size),
                                      VOID (*release)(VOID *));
UINT _gxe_system_pen_configure(GX_PEN_CONFIGURATION *pen_configuration);
UINT _gxe_system_screen_stack_create(GX_WIDGET **memory, INT size,
                                     UINT control_block_size);
UINT _gxe_system_screen_stack_get(GX_WIDGET **popped_parent,
                                  GX_WIDGET **popped_screen);
...
UINT _gx_system_screen_stack_get(GX_WIDGET **popped_parent,
                                 GX_WIDGET **popped_screen);
UINT _gx_system_screen_stack_reset(VOID);
UINT _gxe_system_scroll_appearance_get(
    ULONG style, GX_SCROLLBAR_APPEARANCE *return_appearance);
UINT _gxe_system_scroll_appearance_set(ULONG style,
                                       GX_SCROLLBAR_APPEARANCE *appearance);
UINT _gxe_system_start(VOID);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_system_string_get(GX_RESOURCE_ID string_id,
                            GX_CONST GX_CHAR **return_string);
UINT _gxe_system_string_table_get(GX_UBYTE language, GX_CHAR ***get_table,
                                  UINT *get_size);
UINT _gxe_system_string_width_get(GX_CONST GX_FONT *font,
                                  GX_CONST GX_CHAR *string, INT string_length,
                                  GX_VALUE *return_width);
#endif
UINT _gxe_system_string_width_get_ext(GX_CONST GX_FONT *font,
                                      GX_CONST GX_STRING *string,
                                      GX_VALUE *return_width);
UINT _gxe_system_timer_start(GX_WIDGET *owner, UINT timer_id,
                             UINT initial_ticks, UINT reschedule_ticks);
...
UINT _gxe_system_widget_find(USHORT widget_id, INT search_level,
                             GX_WIDGET **return_search_result);

UINT _gxe_text_button_create(GX_TEXT_BUTTON *button, GX_CONST GX_CHAR *name,
                             GX_WIDGET *parent, GX_RESOURCE_ID text_id,
                             ULONG style, USHORT Id,
                             GX_CONST GX_RECTANGLE *size,
                             UINT text_button_control_block_size);
VOID _gx_text_button_draw(GX_TEXT_BUTTON *button);
UINT _gxe_text_button_event_process(GX_TEXT_BUTTON *button,
                                    GX_EVENT *event_ptr);
...
VOID _gx_text_button_text_draw(GX_TEXT_BUTTON *button);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_text_button_text_get(GX_TEXT_BUTTON *button,
                               GX_CONST GX_CHAR **return_text);
#endif
UINT _gxe_text_button_text_get_ext(GX_TEXT_BUTTON *button,
                                   GX_STRING *return_text);
UINT _gxe_text_button_text_id_set(GX_TEXT_BUTTON *button,
                                  GX_RESOURCE_ID string_id);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_text_button_text_set(GX_TEXT_BUTTON *button, GX_CONST GX_CHAR *text);
#endif
UINT _gxe_text_button_text_set_ext(GX_TEXT_BUTTON *button,
                                   GX_CONST GX_STRING *text);

UINT _gxe_text_input_cursor_blink_interval_set(
    GX_TEXT_INPUT_CURSOR *cursor_input, GX_UBYTE blink_interval);
UINT _gxe_text_input_cursor_height_set(GX_TEXT_INPUT_CURSOR *cursor_input,
                                       GX_UBYTE height);
UINT _gxe_text_input_cursor_width_set(GX_TEXT_INPUT_CURSOR *cursor_input,
                                      GX_UBYTE width);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_text_scroll_wheel_callback_set(
    GX_TEXT_SCROLL_WHEEL *wheel,
    GX_CONST GX_CHAR *(*callback)(GX_TEXT_SCROLL_WHEEL *, INT));
#endif
UINT _gxe_text_scroll_wheel_callback_set_ext(
    GX_TEXT_SCROLL_WHEEL *wheel,
    UINT (*callback)(GX_TEXT_SCROLL_WHEEL *, INT, GX_STRING *));
UINT _gxe_text_scroll_wheel_font_set(GX_TEXT_SCROLL_WHEEL *wheel,
                                     GX_RESOURCE_ID normal_font,
                                     GX_RESOURCE_ID selected_font);
UINT _gxe_text_scroll_wheel_text_color_set(GX_TEXT_SCROLL_WHEEL *wheel,
                                           ...
                                           GX_RESOURCE_ID selected_text_color,
                                           GX_RESOURCE_ID disabled_text_color);
UINT _gxe_text_scroll_wheel_create(GX_TEXT_SCROLL_WHEEL *wheel,
                                   GX_CONST GX_CHAR *name, GX_WIDGET *parent,
                                   INT value_count, ULONG style, USHORT Id,
                                   GX_CONST GX_RECTANGLE *size,
                                   UINT control_block_size);
UINT _gxe_text_scroll_wheel_event_process(GX_TEXT_SCROLL_WHEEL *wheel,
                                          GX_EVENT *event_ptr);
VOID _gx_text_scroll_wheel_draw(GX_TEXT_SCROLL_WHEEL *wheel);

UINT _gxe_tree_view_create(GX_TREE_VIEW *tree, GX_CONST GX_CHAR *name,
                           GX_WIDGET *parent, ULONG style, USHORT tree_id,
                           GX_CONST GX_RECTANGLE *size,
                           UINT control_block_size);
VOID _gx_tree_view_draw(GX_TREE_VIEW *tree);
...
UINT _gxe_tree_view_root_line_color_set(GX_TREE_VIEW *tree,
                                        GX_RESOURCE_ID color);
UINT _gxe_tree_view_root_pixelmap_set(GX_TREE_VIEW *tree,
                                      GX_RESOURCE_ID expand_map_id,
                                      GX_RESOURCE_ID collapse_map_id);
...
UINT _gxe_utility_gradient_create(GX_GRADIENT *gradient, GX_VALUE width,
                                  GX_VALUE height, UCHAR type,
                                  UCHAR alpha_start, UCHAR alpha_end);
UINT _gxe_utility_gradient_delete(GX_GRADIENT *gradient);
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
UINT _gxe_utility_bidi_paragraph_reorder(
    GX_BIDI_TEXT_INFO *input_info,
    GX_BIDI_RESOLVED_TEXT_INFO **resolved_info_head);
UINT _gxe_utility_bidi_paragraph_reorder_ext(
    GX_BIDI_TEXT_INFO *input_info,
    GX_BIDI_RESOLVED_TEXT_INFO **resolved_info_head);
UINT _gxe_utility_bidi_resolved_text_info_delete(
    GX_BIDI_RESOLVED_TEXT_INFO **resolved_info_head);
#endif
UINT _gxe_utility_canvas_to_bmp(GX_CANVAS *canvas, GX_RECTANGLE *rect,
                                UINT (*write_data)(GX_UBYTE *byte_data,
                                                   UINT data_count));
UINT _gxe_utility_circle_point_get(INT xcenter, INT ycenter, UINT r, INT angle,
                                   GX_POINT *point);
UINT _gxe_utility_ltoa(LONG value, GX_CHAR *return_buffer,
                       UINT return_buffer_size);
#if defined(GUIX_5_4_0_COMPATIBILITY)
INT _gx_utility_math_acos_5_4_0(INT x);
INT _gx_utility_math_asin_5_4_0(INT x);
...
UINT _gxe_utility_pixelmap_resize(GX_PIXELMAP *src, GX_PIXELMAP *destination,
                                  INT width, INT height);
UINT _gxe_utility_pixelmap_rotate(GX_PIXELMAP *src, INT angle,
                                  GX_PIXELMAP *destination, INT *rot_cx,
                                  INT *rot_cy);
UINT _gxe_utility_pixelmap_simple_rotate(GX_PIXELMAP *src, INT angle,
                                         GX_PIXELMAP *destination, INT *rot_cx,
                                         INT *rot_cy);

UINT _gxe_utility_rectangle_center(GX_RECTANGLE *rectangle,
                                   GX_RECTANGLE *within);
UINT _gxe_utility_rectangle_center_find(GX_RECTANGLE *rectangle,
                                        GX_POINT *return_center);
UINT _gxe_utility_rectangle_combine(GX_RECTANGLE *first_rectangle,
                                    GX_RECTANGLE *second_rectangle);
GX_BOOL _gxe_utility_rectangle_compare(GX_RECTANGLE *first_rectangle,
                                       GX_RECTANGLE *second_rectangle);
UINT _gxe_utility_rectangle_define(GX_RECTANGLE *rectangle, GX_VALUE left,
                                   GX_VALUE top, GX_VALUE right,
                                   GX_VALUE bottom);
GX_BOOL
_gxe_utility_rectangle_overlap_detect(GX_RECTANGLE *first_rectangle,
                                      GX_RECTANGLE *second_rectangle,
                                      GX_RECTANGLE *return_overlap_area);
GX_BOOL _gxe_utility_rectangle_point_detect(GX_RECTANGLE *rectangle,
                                            GX_POINT point);
UINT _gxe_utility_rectangle_resize(GX_RECTANGLE *rectangle, GX_VALUE adjust);
UINT _gxe_utility_rectangle_shift(GX_RECTANGLE *rectangle, GX_VALUE x_shift,
                                  GX_VALUE y_shift);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_utility_string_to_alphamap(GX_CONST GX_CHAR *text,
                                     GX_CONST GX_FONT *font,
                                     GX_PIXELMAP *textmap);
#endif
UINT _gxe_utility_string_to_alphamap_ext(GX_CONST GX_STRING *text,
                                         GX_CONST GX_FONT *font,
                                         GX_PIXELMAP *textmap);

UINT _gxe_vertical_list_children_position(GX_VERTICAL_LIST *vertical_list);
UINT _gxe_vertical_list_create(
    GX_VERTICAL_LIST *vertical_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
    INT total_rows, VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *, INT),
    ULONG style, USHORT vertical_list_id, GX_CONST GX_RECTANGLE *size,
    UINT vertical_list_control_block_size);
UINT _gxe_vertical_list_event_process(GX_VERTICAL_LIST *list,
                                      GX_EVENT *event_ptr);
...
UINT _gxe_vertical_list_selected_index_get(GX_VERTICAL_LIST *vertical_list,
                                           INT *return_index);
UINT _gxe_vertical_list_selected_set(GX_VERTICAL_LIST *vertical_list,
                                     INT index);
...
UINT _gxe_vertical_scrollbar_create(GX_SCROLLBAR *scrollbar,
                                    GX_CONST GX_CHAR *name, GX_WINDOW *parent,
                                    GX_SCROLLBAR_APPEARANCE *settings,
                                    ULONG style,
                                    UINT scrollbar_control_blcok_size);
...
UINT _gxe_widget_block_move(GX_WIDGET *widget, GX_RECTANGLE *block, INT x_shift,
                            INT y_shift);
VOID _gx_widget_border_draw(GX_WIDGET *widget, GX_RESOURCE_ID border_color,
...
UINT _gxe_widget_color_get(GX_WIDGET *widget, GX_RESOURCE_ID color_id,
                           GX_COLOR *return_color);
UINT _gxe_widget_child_detect(GX_WIDGET *parent, GX_WIDGET *child,
                              GX_BOOL *return_detect);
VOID _gx_widget_children_draw(GX_WIDGET *widget);
UINT _gxe_widget_client_get(GX_WIDGET *widget, GX_VALUE border_width,
                            GX_RECTANGLE *return_size);
UINT _gxe_widget_create(GX_WIDGET *widget, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, ULONG style, USHORT Id,
...
UINT _gxe_widget_event_generate(GX_WIDGET *widget, USHORT event_type,
                                LONG value);
UINT _gxe_widget_event_process(GX_WIDGET *widget, GX_EVENT *event_ptr);
UINT _gxe_widget_event_process_set(
    GX_WIDGET *widget,
    UINT (*event_processing_function)(GX_WIDGET *, GX_EVENT *));
UINT _gxe_widget_event_to_parent(GX_WIDGET *widget, GX_EVENT *event_ptr);
UINT _gxe_widget_fill_color_set(GX_WIDGET *widget, GX_RESOURCE_ID normal_color,
                                GX_RESOURCE_ID selected_color,
                                GX_RESOURCE_ID disabled_color);
UINT _gxe_widget_find(GX_WIDGET *parent, USHORT widget_id, INT search_depth,
                      GX_WIDGET **return_widget);
...
UINT _gxe_widget_font_get(GX_WIDGET *widget, GX_RESOURCE_ID font_id,
                          GX_FONT **return_font);
...
UINT _gxe_widget_next_sibling_get(GX_WIDGET *current,
                                  GX_WIDGET **sibling_return);
UINT _gxe_widget_parent_get(GX_WIDGET *current, GX_WIDGET **parent_return);
UINT _gxe_widget_pixelmap_get(GX_WIDGET *widget, GX_RESOURCE_ID pixelmap_id,
                              GX_PIXELMAP **return_pixelmap);
UINT _gxe_widget_previous_sibling_get(GX_WIDGET *current,
                                      GX_WIDGET **sibling_return);
UINT _gxe_widget_resize(GX_WIDGET *widget, GX_RECTANGLE *newsize);
UINT _gxe_widget_shift(GX_WIDGET *widget, GX_VALUE x_shift, GX_VALUE y_shift,
                       GX_BOOL mark_dirty);
...
UINT _gxe_widget_status_test(GX_WIDGET *widget, ULONG status,
                             GX_BOOL *return_test);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_widget_string_get(GX_WIDGET *widget, GX_RESOURCE_ID string_id,
                            GX_CONST GX_CHAR **return_string);
#endif
UINT _gxe_widget_string_get_ext(GX_WIDGET *widget, GX_RESOURCE_ID string_id,
                                GX_STRING *return_string);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_widget_text_blend(GX_WIDGET *widget, UINT tColor, UINT font_id,
                            GX_CONST GX_CHAR *string, INT x_offset,
                            INT y_offset, UCHAR alpha);
VOID _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id,
                          GX_CONST GX_CHAR *string, INT x_offset, INT y_offset);
#endif
...
UINT _gxe_widget_top_visible_child_find(GX_WIDGET *parent,
                                        GX_WIDGET **child_return);
...
UINT _gxe_window_client_scroll(GX_WINDOW *window, GX_VALUE xscroll,
                               GX_VALUE yscroll);
UINT _gxe_window_client_width_get(GX_WINDOW *window, GX_VALUE *return_width);
UINT _gxe_window_close(GX_WINDOW *window);
UINT _gxe_window_create(GX_WINDOW *window, GX_CONST GX_CHAR *name,
                        GX_WIDGET *parent, ULONG style, USHORT Id,
                        GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_window_root_create(GX_WINDOW_ROOT *root_window,
                             ...
                             ULONG style, USHORT Id,
                             GX_CONST GX_RECTANGLE *size,
                             UINT root_window_control_block_size);
...
UINT _gxe_window_root_find(GX_WIDGET *widget,
                           GX_WINDOW_ROOT **return_root_window);
UINT _gxe_window_scroll_info_get(GX_WINDOW *window, ULONG type,
                                 GX_SCROLL_INFO *return_scroll_info);
UINT _gxe_window_scrollbar_find(GX_WINDOW *window, USHORT type,
                                GX_SCROLLBAR **return_scrollbar);
UINT _gxe_window_wallpaper_get(GX_WINDOW *window,
                               GX_RESOURCE_ID *return_wallpaper_id);
UINT _gxe_window_wallpaper_set(GX_WINDOW *window, GX_RESOURCE_ID wallpaper_id,
                               GX_BOOL tile);
