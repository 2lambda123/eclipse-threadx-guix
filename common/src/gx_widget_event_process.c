...
/*                                                                        */
/**************************************************************************/
static VOID _gx_widget_children_show_event_process(GX_WIDGET *widget,
                                                   GX_EVENT *event_ptr) {
  ...
  case GX_EVENT_FOCUS_GAINED:
    ...
    if (!(widget->gx_widget_status & GX_STATUS_HAS_FOCUS) &&
      ...
      if (widget->gx_widget_parent) {
        if (!(widget->gx_widget_parent->gx_widget_status &
              GX_STATUS_HAS_FOCUS)) {
          widget->gx_widget_parent->gx_widget_event_process_function(
              widget->gx_widget_parent, event_ptr);
        }

        /* test to see if this widget should notify it's parent when it gains
         * focus */
        if (widget->gx_widget_id &&
            widget->gx_widget_status & GX_STATUS_NOTIFY_ON_GAIN_FOCUS) {
